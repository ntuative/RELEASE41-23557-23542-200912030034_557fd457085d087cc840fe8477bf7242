package deng.fzip
{
   ...
   public class FZipFile
   {
      ...
      public static const const_617:int = 8;
      
      public static const const_1484:int = 10;
      
      public static const const_1176:int = 6;
      
      private static var var_917:Boolean = describeType(ByteArray).factory.method.(@name == "uncompress").hasComplexContent();
      ...
      public static const const_1429:int = 5;
      
      public static const const_1417:int = 9;
      
      public static const const_1494:int = 7;
       
      
      private var var_167:uint = 0;
      
      private var var_918:uint = 0;
      ...
      {
         var _loc2_:* = 0;
         if(var_616 === const_617 && !var_1379)
         {
            if(var_917)
            {
               param1.readBytes(var_33,0,var_167);
            }
            else
            {
               if(!var_439)
               ...
               _loc2_ = uint(~var_1741 << 6 & 192);
               _loc2_ += 31 - (30720 | _loc2_) % 31;
               var_33.writeByte(_loc2_);
               param1.readBytes(var_33,2,var_167);
         ...
         {
            if(var_616 != const_1327)
            {
               throw new Error("Compression method " + var_616 + " is not supported.");
            }
            param1.readBytes(var_33,0,var_167);
            var_168 = false;
         }
      ...
      public function setContentAsString(param1:String, param2:String = "utf-8") : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            var_614 = ChecksumUtil.CRC32(var_33);
            var_439 = false;
         }
         compress();
      }
      ...
      {
         var_615 = param1 != null ? param1 : new Date();
      }
      ...
      public function serialize(param1:IDataOutput, param2:Boolean, param3:Boolean = false, param4:uint = 0) : uint
      {
         ...
         if(param3)
         {
            ...
            param1.writeShort(var_1114 << 8 | 20);
         }
         else
         {
         ...
         param1.writeShort(const_617);
         var _loc5_:Date = var_615 != null ? var_615 : new Date();
         var _loc6_:uint = uint(_loc5_.getSeconds()) | uint(_loc5_.getMinutes()) << 5 | uint(_loc5_.getHours()) << 11;
         var _loc7_:uint = uint(_loc5_.getDate()) | uint(_loc5_.getMonth() + 1) << 5 | uint(_loc5_.getFullYear() - 1980) << 9;
         param1.writeShort(_loc6_);
         param1.writeShort(_loc7_);
         param1.writeUnsignedInt(var_614);
         param1.writeUnsignedInt(var_167);
         param1.writeUnsignedInt(var_523);
         ...
         {
            _loc8_.writeMultiByte(var_378,var_322);
         }
         ...
         if(param3 && false)
         {
            ...
            {
               _loc8_.writeMultiByte(var_1742,var_322);
            }
         }
      ...
      protected function compress() : void
      {
         if(!var_168)
         {
            ...
            {
               var_33.position = 0;
               var_523 = var_33.length;
               if(var_917)
               {
                  var_33.compress.apply(var_33,["deflate"]);
                  var_167 = var_33.length;
               }
               else
               {
                  var_33.compress();
      ...
      {
         if(param1.bytesAvailable >= var_918 + var_1115)
         {
            parseHeadExt(param1);
            parseFunc = parseFileContent;
            return true;
      ...
      protected function parseHeadExt(param1:IDataInput) : void
      {
         ...
         if(var_322 == "utf-8")
         {
            var_378 = param1.readUTFBytes(var_918);
         }
         else
         {
            var_378 = param1.readMultiByte(var_918,var_322);
         }
         var _loc2_:uint = var_1115;
         while(_loc2_ > 4)
         {
      ...
      protected function parseHead(param1:IDataInput) : void
      {
         ...
         var_1114 = _loc2_ >> 8;
         var_1380 = Math.floor((_loc2_ & 255) / 10) + "." + (_loc2_ & 255) % 10;
         var _loc3_:uint = param1.readUnsignedShort();
         var_616 = param1.readUnsignedShort();
         var_1379 = (_loc3_ & 1) !== 0;
         var_1378 = (_loc3_ & 8) !== 0;
         var_1740 = (_loc3_ & 32) !== 0;
         if((_loc3_ & 800) !== 0)
         {
            var_322 = "utf-8";
         }
         if(var_616 === const_1176)
         {
            var_2176 = (_loc3_ & 2) !== 0 ? 8192 : 4096;
            var_2177 = (_loc3_ & 4) !== 0 ? 3 : 2;
         }
         else if(var_616 === const_617)
         {
            var_1741 = (_loc3_ & 6) >> 1;
         }
         ...
         var_615 = new Date(_loc11_,_loc10_ - 1,_loc9_,_loc8_,_loc7_,_loc6_,0);
         var_614 = param1.readUnsignedInt();
         var_167 = param1.readUnsignedInt();
         var_523 = param1.readUnsignedInt();
         var_918 = param1.readUnsignedShort();
         var_1115 = param1.readUnsignedShort();
      }
      ...
      {
         return "[FZipFile]\n  name:" + var_378 + "\n  date:" + var_615 + "\n  sizeCompressed:" + var_167 + "\n  sizeUncompressed:" + var_523 + "\n  versionHost:" + var_1114 + "\n  versionNumber:" + var_1380 + "\n  compressionMethod:" + var_616 + "\n  encrypted:" + var_1379 + "\n  hasDataDescriptor:" + var_1378 + "\n  hasCompressedPatchedData:" + var_1740 + "\n  filenameEncoding:" + var_322 + "\n  crc32:" + var_614.toString(16) + "\n  adler32:" + var_735.toString(16);
      }
