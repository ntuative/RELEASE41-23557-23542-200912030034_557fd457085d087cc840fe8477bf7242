package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      private var var_874:ICore;
      
      private var var_1519:ICoreConfigStatusListener;
      ...
      {
         initCore("config_habbo.xml",Core.const_959);
      }
      ...
      private function prepareBakedInComponent(param1:Class) : void
      {
         ...
         var_874.prepareComponent(manifest,resource);
      }
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_874 = Core.instantiate(this,param2);
         initBakedInComponents();
         var_874.events.addEventListener(Component.COMPONENT_EVENT_ERROR,onCoreError);
         var_874.loadExternalConfigDocument(new URLRequest(param1),var_1519);
      }
   }
}
