package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_443:IRoomObjectFactory = null;
      
      private var var_1421:int;
      
      private var var_2241:IRoomContentLoader;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         var_444 = [];
         var_431 = [];
         _events.addEventListener(RoomContentLoadedEvent.const_421,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_362,onContentLoaded);
         _events.addEventListener(RoomContentLoadedEvent.const_686,onContentLoaded);
      }
      
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         var _loc5_:* = null;
         if(_state == const_1214)
         {
            if(var_753 != null)
            {
               return false;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = var_380.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = var_380.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = var_443.createRoomObjectLogic(_loc11_);
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_443 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = var_431.indexOf(param1);
         if(_loc2_ < 0)
         {
            return;
         }
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(var_443 != null)
         {
            return var_443.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(var_51.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = var_444.indexOf(param1);
            if(_loc2_ >= 0)
            {
               var_444.splice(_loc2_,1);
            }
            if(false)
            {
                  ...
                  while(_loc13_ >= 0)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           _loc5_ = var_380.getRoomObjectVisualizationData(_loc15_,_loc17_,_loc2_);
                           _loc19_ = var_380.createRoomObjectVisualization(_loc17_);
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = var_443.createRoomObjectLogic(_loc18_);
