package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_574:Number = 64;
      
      public static const const_820:Number = 32;
      ...
      private var var_1306:Number = 1;
      
      private var var_2221:Number = 500;
      
      private var var_1307:Number = 1;
      
      private var var_90:Vector3d;
      
      private var var_89:Vector3d;
      
      private var var_2222:Number = -500;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         _y = new Vector3d();
         var_89 = new Vector3d();
         var_882 = new Vector3d();
         var_1308 = 1;
         var_1307 = 1;
         x_scale = 1;
         y_scale = 1;
         var_1306 = Math.sqrt(0.5) / Math.sqrt(0.75);
         z_scale = 1;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:* = 0;
         var_209.assign(param1);
         if(var_209.x != _loc2_ || var_209.y != _loc3_ || var_209.z != _loc4_)
         {
            ++var_83;
         }
      ...
      {
         if(var_360 != param1 * var_1306)
         {
            var_360 = param1 * var_1306;
            ++var_83;
         }
      }
      ...
      {
         if(var_361 != param1 * var_1308)
         {
            var_361 = param1 * var_1308;
            ++var_83;
         }
      }
      ...
      {
         if(var_359 != param1 * var_1307)
         {
            var_359 = param1 * var_1307;
            ++var_83;
         }
      }
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(var_358 != null)
         {
            ...
            var_358.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            var_358.add(_loc3_,_loc4_);
            ++var_83;
         }
      }
      ...
      {
         return new Vector3d(var_209.x,var_209.y,var_209.z);
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_882.assign(_loc22_);
         }
         else
         {
            var_882.assign(_loc17_);
         }
         ++var_83;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_359;
         _loc2_.z *= var_360;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_882);
         if(_loc3_ < var_2222 || _loc3_ > var_2221)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_359;
            _loc2_.z *= var_360;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_882);
         }
      ...
      {
         return new Vector3d(0 * var_361,0 * var_359,0 * var_360);
      }
      ...
      {
         return scale == const_574;
      }
      
      public function get scale() : Number
      {
         return var_195 / Math.sqrt(0.5);
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(var_358 != null)
         {
            ...
            return var_358.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc5_:Number = param1.x / var_195;
         var _loc6_:Number = -param1.y / var_195;
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(var_90,_loc5_),Vector3d.product(_y,_loc6_));
         var _loc8_:Vector3d = new Vector3d(0 * var_361,0 * var_359,0 * var_360);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_89;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_361,param2.y * var_359,param2.z * var_360);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_361,param3.y * var_359,param3.z * var_360);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_361,param4.y * var_359,param4.z * var_360);
