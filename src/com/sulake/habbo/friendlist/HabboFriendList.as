package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1737:IAvatarRenderManager;
      
      private var var_1377:AvatarSearchResults;
      
      private var var_126:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_734:FriendRequests;
      
      private var var_1706:int;
      
      var var_337:FriendCategories;
      
      private var var_198:IHabboToolbar;
      
      private var var_1738:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_389:FriendListTabs;
      
      private var var_1739:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1376:OpenedToWebPopup;
      ...
      {
         var_1738 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_337 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1377 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1376 == null)
         {
            var_1376 = new OpenedToWebPopup(this);
         }
         var_1376.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_734.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_734.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_389.findTab(FriendListTab.const_92).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_734.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_198.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_126 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_337.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_734 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_337.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_337.addCategory(new FriendCategory(FriendCategory.const_947,getText("friendlist.friends")));
         var_337.addCategory(new FriendCategory(FriendCategory.const_420,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_337.addFriend(new Friend(_loc4_));
         }
         var_389 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_337.onFriendListUpdate(param1);
      ...
      public function openFriendList() : void
      {
         ...
         var _loc1_:FriendListTab = tabs.findTab(FriendListTab.const_78);
      ...
      {
         var _loc2_:IAvatarImage = var_1737.createAvatarImage(param1,AvatarScaleType.const_95);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1737 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_734.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_389.findTab(FriendListTab.const_92);
      ...
      {
         var_1739 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_337.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_389.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_298));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_78:
                     trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_310:
      ...
      {
         var_198 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1377.searchReceived(_loc2_.friends,_loc2_.others);
