package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1390:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_friendList.getXmlWindow(this.var_1137));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1390[var_1137]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(_friendList.view.mainWindow,var_273.width,var_273.height);
         var_273.x = _loc2_.x;
         var_273.y = _loc2_.y;
         var_1390[var_1137] = var_273;
      }
   }
}
