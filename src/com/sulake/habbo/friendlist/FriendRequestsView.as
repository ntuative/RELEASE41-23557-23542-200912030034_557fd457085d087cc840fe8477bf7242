package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1372:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_292 && _loc4_.state != FriendRequest.const_299)
            {
      ...
      {
         var_1465 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1464 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1464.procedure = onDismissAllButtonClick;
         var_1465.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_92,param2);
      ...
      private function onDeclineButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc4_.state = FriendRequest.const_299;
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_148)
         {
         ...
         else if(param1.state == FriendRequest.const_299)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1465,_loc1_);
         setEnabled(var_1464,_loc1_);
      }
