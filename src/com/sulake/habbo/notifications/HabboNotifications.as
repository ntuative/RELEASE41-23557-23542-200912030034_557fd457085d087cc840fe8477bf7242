package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1074:String = "badges";
      
      private static const const_1080:String = "pixelbalance";
      
      private static const const_1079:String = "credits";
      
      private static const const_1077:String = "inventory";
      
      private static const const_1075:String = "friendlist";
      
      private static const const_1078:String = "selectfurni";
      
      private static const const_1076:String = "selectbadge";
       
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_566:ParkBusDialogManager;
      
      private var var_1263:IHabboToolbar;
      ...
      private var var_408:HabboNotificationViewManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_826);
         }
         var _loc6_:Map = var_826["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1131);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1242);
         }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_203 == null)
         {
            return;
         }
         var_203.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_203.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_203.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2085)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_962);
            var_2085 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1244.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_915,_loc5_);
         }
      }
      ...
      {
         if(param1 != null && this.var_408 != null)
         {
            var_408.replaceIcon(param1);
         }
      }
      ...
      {
         if(var_408.isSpaceAvailable() && false)
         {
            var_408.showItem(getNextItemFromQueue());
         }
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_566 == null)
         {
            var_566 = new ParkBusDialogManager(_windowManager,assets,_localization);
         }
         if(_loc2_ != null || var_566 != null)
         {
            var_566.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = var_995.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1244.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_521);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_206 || param2.type == WindowEvent.const_678)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            {
               _loc16_ = var_521.getProductData(_loc15_.productType);
               _loc17_ = var_521.getFurnitureData(_loc15_.furniClassId);
               _loc7_ = var_521.getProductData(_loc4_.localizationId);
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_962,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1244.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_203.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      {
         var_1263 = IHabboToolbar(param2);
         var_1263.events.addEventListener(HabboToolbarEvent.const_77,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_191);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_203 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_521.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_966);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_966);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_203.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_279;
            }
            if(param2 == 3002)
            {
               return FurniCategory.const_286;
            }
            if(param2 == 4057)
            {
               return FurniCategory.const_273;
            }
            return 1;
         }
         return 1;
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_77)
         {
            ...
            var_408 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_826["styles"],var_826["view"],var_1263);
            ...
            registerUpdateReceiver(var_408,1);
            registerUpdateReceiver(this,2);
            var_521.events.addEventListener(BadgeImageReadyEvent.const_117,onBadgeImage);
            var_1263.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
