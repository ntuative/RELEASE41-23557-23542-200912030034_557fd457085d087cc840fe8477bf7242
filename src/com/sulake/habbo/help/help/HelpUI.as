package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1370:int = 0;
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23557-23542-200912030010");
         var_198 = param5;
         var_109 = new Map();
         var_109.add(HabboHelpViewEnum.const_1188,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_136,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_439,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_265,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_200,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_631,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_320,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_655,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_213,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_109.add(HabboHelpViewEnum.const_787,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_109.add(HabboHelpViewEnum.const_511,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_260 == HabboHelpViewEnum.const_136 || false)
         {
            return;
         }
         if(var_398 == null)
         {
            ...
            var_398 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_398 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_398 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_398 as IWindow);
      ...
      {
         return var_109.getValue(var_260);
      }
      
      public function get localization() : IHabboLocalizationManager
      {
         return var_41.localization;
      }
      ...
      {
         var_1987 = param1;
         var _loc2_:IHelpViewController = var_109.getValue(HabboHelpViewEnum.const_136) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_213:
               showUI(HabboHelpViewEnum.const_213);
               break;
            case CallForHelpResultEnum.const_937:
               showUI(HabboHelpViewEnum.const_787);
               break;
            case CallForHelpResultEnum.const_902:
      ...
      {
         var _loc3_:* = null;
         if(var_260 == HabboHelpViewEnum.const_136)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_398.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.width = _loc1_.width + var_1457;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_198 != null)
            {
               var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.HELP,_window));
            }
         }
         var_41.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT));
      }
      ...
      public function hideUI() : void
      {
         ...
         var_260 = var_1986;
         var_41.events.dispatchEvent(new Event(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED));
      }
      
      public function sendMessage(param1:IMessageComposer) : void
      {
         var_41.sendMessage(param1);
      }
      
      public function getFaq() : FaqIndex
      {
         return var_41.getFaq();
      }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_41.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_697));
      }
      ...
      {
         return var_41.getConfigurationKey(param1,param2,param3);
      }
   }
}
