package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_590:FaqCategory;
      
      private var var_591:FaqCategory;
      ...
      {
         var _loc4_:* = null;
         if(var_591.hasItem(param1))
         {
            var_591.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_590.hasItem(param1))
         {
            var_590.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
         while(_loc3_ < var_125.length)
         {
            _loc4_ = var_125.getWithIndex(_loc3_);
      ...
      public function dispose() : void
      {
         ...
         if(var_125 != null)
         {
            ...
            {
               _loc2_ = var_125.getWithIndex(_loc1_);
               _loc2_.dispose();
               _loc1_++;
            }
            var_125.dispose();
      ...
      {
         if(param1 >= var_125.length)
         {
            return null;
         }
         return var_125.getWithIndex(param1);
      }
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(var_590.hasItem(param1))
         {
            return var_590.getItem(param1);
         }
         var _loc2_:int = 0;
         while(_loc2_ < var_125.length)
         {
            _loc3_ = var_125.getWithIndex(_loc2_);
      ...
      public function getCategoryTitleArray() : Array
      {
         ...
         while(_loc3_ < var_125.length)
         {
            _loc2_ = var_125.getWithIndex(_loc3_);
            if(_loc2_ != null)
            {
