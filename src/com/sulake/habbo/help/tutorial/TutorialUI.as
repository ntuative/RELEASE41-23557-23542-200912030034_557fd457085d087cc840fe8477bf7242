package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_266:String = "TUI_NAME_VIEW";
      
      public static const const_82:String = "TUI_MAIN_VIEW";
      
      public static const const_304:String = "TUI_CLOTHES_VIEW";
      
      public static const const_343:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_55 = param1;
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_697,onTaskDoneEvent);
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_591,onTaskDoneEvent);
         var_55.events.addEventListener(HabboHelpTutorialEvent.const_679,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_55.hideUI();
         var_55.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_96));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_932 = true;
         if(var_40 != null && (var_40.id == const_266 || var_40.id == const_82))
         {
            showView(const_82);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.width = _loc2_.width + var_1457;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_697:
               var_933 = true;
               if(var_40 != null && var_40.id == const_343)
               {
                  showView(const_82);
               }
               break;
            case HabboHelpTutorialEvent.const_591:
               if(var_40 != null && var_40.id == const_304)
               {
                  var_1147 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_679:
               if(var_1147)
               {
                  var_1147 = false;
                  showView(const_82);
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode != ChangeUserNameResultMessageEvent.var_858)
         {
            showView(const_266);
      ...
      {
         var_931 = true;
         if(var_40 != null && (var_40.id == const_304 || var_40.id == const_82))
         {
            showView(const_82);
         }
      }
      ...
      {
         return var_931 && var_932 && var_933;
      }
   }
}
