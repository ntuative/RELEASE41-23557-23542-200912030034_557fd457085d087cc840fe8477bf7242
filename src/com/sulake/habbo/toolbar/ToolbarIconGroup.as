package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_411:ToolbarBarMenuAnimator;
      
      private var var_1184:Array;
      
      private var var_138:Number;
      
      private var var_1908:XML;
      
      private var var_1907:int;
      
      private var var_1183:Number;
      ...
      {
         return var_1182.indexOf(param1) > -1;
      }
      ...
      {
         return var_644.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1184.length)
         {
            _loc2_ = var_644.indexOf(var_1184[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_291[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_715 + _loc3_);
                  _loc3_ += var_1183;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_411);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_644.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_291[var_644.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1908.elements("menu");
         var _loc5_:int = 0;
