package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_619.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_110,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_852,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_161,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_163,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_47,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_400,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_555,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_898,onHideWindowEvent);
         _state = true;
