package com.sulake.habbo.communication.demo
{
   ...
   public class SSOTicket extends EventDispatcher
   {
      ...
      private var var_1170:IHabboWebLogin;
      ...
      public function SSOTicket(param1:IAssetLibrary, param2:IHabboWebLogin, param3:String)
      {
         ...
         _assets = param1;
         var_1170 = param2;
         var_1169 = "http://" + param3 + "/client";
         var_1170.init();
         var_1170.addEventListener(HabboWeb.const_190,requestClientURL);
      }
      ...
      {
         var _loc2_:String = var_1169;
         if(_assets.hasAsset(_loc2_))
         {
            Logger.log("[CoreLocalizationManager] reload localization for url: " + var_1169);
         }
         var _loc3_:URLRequest = new URLRequest(var_1169);
         if(_assets.hasAsset(_loc2_))
         {
      ...
      private function clientURLComplete(param1:Event = null) : void
      {
         ...
         {
            var_1170.requestReAuthenticate();
         }
         else
         {
            try
            {
               var_1423 = /\"sso.ticket\" : \"(.*?)\"/.exec(data)[1];
               var_1870 = /\"flash.client.url\" : \"(.*?)\"/.exec(data)[1];
               if(false)
               {
