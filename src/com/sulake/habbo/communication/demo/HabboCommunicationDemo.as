package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_171:HabboHotelView;
      ...
      private var var_1945:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1362:ILogger;
      ...
      private var var_464:IKeyExchange;
      ...
      private var var_80:IHabboCommunicationManager;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         if(var_969)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_17);
         }
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_321:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_816:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_897:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_859:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1947)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_647 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_647);
            _loc2_.send(_loc4_);
            dispatchLoginStepEvent(HabboCommunicationEvent.const_24);
         }
         else if(_view != null)
         {
            _loc5_ = "null";
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1203,var_1946));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1354,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_464.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_464.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1945);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1354,"/");
      ...
      {
         var_647 = _habboConfiguration.getKey("sso.ticket",null);
         var_1203 = _habboConfiguration.getKey("flash.client.url","");
         var_1946 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_171 == null)
         {
            var_171 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_647 != null)
         {
            var_80.mode = HabboConnectionType.const_461;
            var_80.initConnection(HabboConnectionType.const_231);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1362 = param2 as ILogger;
      }
      ...
      private function onHabboCommunication(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            var_80 = param2 as IHabboCommunicationManager;
            _loc3_ = var_80.getHabboMainConnection(null);
            if(_loc3_ != null)
            {
            ...
            var_80.addHabboConnectionMessageEvent(new HelloMessageEvent(onHelloEvent));
            var_80.addHabboConnectionMessageEvent(new InitCryptoMessageEvent(onInitCrypto));
            var_80.addHabboConnectionMessageEvent(new SecretKeyEvent(onSecretKeyEvent));
            var_80.addHabboConnectionMessageEvent(new SessionParamsMessageEvent(onSessionParamsEvent));
            var_80.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
            var_80.addHabboConnectionMessageEvent(new PingMessageEvent(onPing));
            var_80.addHabboConnectionMessageEvent(new ErrorReportEvent(onErrorReport));
            var_80.addHabboConnectionMessageEvent(new UserObjectEvent(onUserObject));
            var_80.addHabboConnectionMessageEvent(new GenericErrorEvent(onGenericError));
            var_80.addHabboConnectionMessageEvent(new DisconnectReasonEvent(onDisconnectReason));
            var_80.addHabboConnectionMessageEvent(new RoomEntryInfoMessageEvent(onRoomEntryInfoEvent));
            var_80.addHabboConnectionMessageEvent(new UniqueMachineIDEvent(onUniqueMachineId));
         }
      }
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IConnection = var_80.getHabboMainConnection(null);
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_689);
            _loc3_ = new InitCryptoMessageComposer(var_80.mode);
            _loc2_.send(_loc3_);
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1945 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_80.mode)
         {
            case HabboConnectionType.const_461:
               _loc6_ = "";
               ...
               var_970 = _loc4_;
               var_171.loadBannerImage(_loc7_ + "?token=" + var_970,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1166:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1238:
               var_971 = generateRandomHexString(30);
               var_464 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_464.init(var_971);
               _loc8_ = var_464.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_171.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_970);
         ...
         var _loc9_:IConnection = var_80.getHabboMainConnection(null);
         ...
         var_464 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_971 = generateRandomHexString(30);
            var_464.init(var_971);
            _loc12_ = var_464.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_14,onConfigurationLoaded);
         }
      }
