package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_686:IAssetLibrary;
      ...
      {
         var _loc3_:AssetLoaderStruct = var_686.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_686.getAssetByName(_loc2_.assetName);
         if(param1.type == AssetLoaderEvent.const_44)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_61));
            }
         }
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_404));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_686.loadAssetFromFile("hotel_view_banner_" + var_847,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_493));
            }
            var_183 = param2;
