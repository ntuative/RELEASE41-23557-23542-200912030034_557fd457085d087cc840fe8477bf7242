package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private static const const_757:uint = 11;
      ...
      private var var_1251:LagWarningLogger = null;
      
      private var var_814:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1251 = new LagWarningLogger();
         var_1250 = new Array(const_757);
         var _loc4_:int = 0;
         while(_loc4_ < const_757)
         {
            var_1250[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1107,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1297,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_671,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_869,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_689:
               trackLoginStep(HabboLoginTrackingStep.const_19,String(_communication.port));
               break;
      ...
      {
         var_175 = IHabboConfigurationManager(param2);
         if(var_175)
         {
            Component(var_175).events.addEventListener(HabboConfigurationEvent.const_14,onConfigurationLoaded);
            if(var_225 != null)
            {
               var_225.configuration = var_175;
            }
            if(var_226 != null)
            {
               var_226.configuration = var_175;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_474.events.addEventListener(AdEvent.const_370,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_869,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_671,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_689,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_493,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_404,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_438:
               var_1251.registerWarning(LagWarningLogger.const_920);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_814)
            {
               var_814.release(new IIDHabboWindowManager());
               var_814 = null;
            }
            if(var_474)
            {
               var_474.release(new IIDHabboAdManager());
               var_474 = null;
            }
            if(_navigator)
            {
            ...
            if(var_176)
            {
               if(true)
               {
                  ...
                  Component(var_176).events.removeEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
               }
            ...
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_438,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_175)
         {
            Component(var_175).events.removeEventListener(HabboConfigurationEvent.const_14,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_13,onLocalizationLoaded);
         }
      }
      ...
      private function onCoreRunning(param1:Event) : void
      {
         ...
         {
            _coreComponent.events.removeEventListener(HabboLoginTrackingStep.const_22,onCoreRunning);
         }
      }
      ...
      {
         var_814 = IHabboWindowManager(param2);
         if(var_814)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_990 > -1 && _loc2_ < var_990)
         {
            ++var_1482;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1482);
         }
         if(var_990 > -1 && _loc2_ - var_990 > 15000)
         {
            ++var_1481;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1481);
         }
         var_990 = _loc2_;
         if(var_226 != null)
         {
         ...
         if(var_1251 != null)
         {
            var_1251.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_175 != null && Boolean(var_175.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_438,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_245,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_176).events.addEventListener(HabboFriendListTrackingEvent.const_298,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_2039)
         {
            var_2039 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1271,new Date().getTime().toString());
            if(var_175)
            {
               if(var_175.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_175.getKey("client.fatal.error.url");
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_13,onLocalizationLoaded);
         }
      }
      
      private function onHotelViewEvent(param1:Event) : void
      {
         if(param1.type == HabboHotelViewEvent.const_493)
         {
         ...
         else if(param1.type == HabboHotelViewEvent.const_61)
         {
