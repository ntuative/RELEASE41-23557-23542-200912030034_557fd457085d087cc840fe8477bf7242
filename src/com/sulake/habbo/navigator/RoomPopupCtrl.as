package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1728 = new RoomThumbnailRenderer(param1);
         var_964 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_169,var_116.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_169.findChildByName("roomowner"));
         if(true)
         {
            _loc1_.procedure = onOwnerName;
            _loc1_.setParamFlag(HabboWindowParam.const_34,true);
            _loc1_.underline = true;
         }
         else
         {
            _loc1_.procedure = null;
            _loc1_.setParamFlag(HabboWindowParam.const_34,false);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_964.refreshTags(_loc1_,var_116.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1728.refreshThumbnail(_loc1_,var_116.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_169,var_116);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_169,!true ? getEventCtg(var_116.categoryId) : getRoomCtg(var_116.categoryId));
         refreshRoomDesc(var_169,var_116);
         refreshExtraCont();
         refreshInfo(var_169,"trading_allowed",var_116.allowTrading);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_197,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
