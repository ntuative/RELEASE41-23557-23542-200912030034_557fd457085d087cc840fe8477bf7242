package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class ThumbnailImageConfiguration
   {
      ...
      private var var_1587:Rectangle;
      ...
      public function getImg() : BitmapData
      {
         ...
         {
            this.var_1584 = this._navigator.getButtonImage(this.var_1585);
         }
      ...
      private function refreshListImg() : void
      {
         ...
         if(this.var_1587 == null)
         {
            ...
            this.var_1587 = new Rectangle(var_1323,var_1323,_loc1_.width - 2 * var_1323,_loc1_.height - 2 * var_1323);
         }
         var_595.bitmap.fillRect(var_595.bitmap.rect,4281545523);
         var_595.bitmap.fillRect(this.var_1587,4284900966);
         copyTo(var_595.bitmap);
         if(_selected)
         {
            var_595.bitmap.copyPixels(var_1586,var_1586.rect,new Point(0,0),null,null,true);
         }
         var_595.invalidate();
      }
