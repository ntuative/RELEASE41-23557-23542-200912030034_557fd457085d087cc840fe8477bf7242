package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1910:IWindowContainer;
      ...
      private var var_1430:IButtonWindow;
      ...
      {
         setEnabled(_bgTabButton,this.var_92.mode != ThumbnailEditorModel.const_36);
         setEnabled(var_1430,this.var_92.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1431,this.var_92.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_92.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1430 = IButtonWindow(find("top_tab"));
         var_1431 = IButtonWindow(find("obj_tab"));
         var_1911 = IWindowContainer(find("tile_grid"));
         var_1910 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1430,onTopTabButton);
         Util.setProcDirectly(var_1431,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1911;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_351)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1910;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,param1.width,66)));
