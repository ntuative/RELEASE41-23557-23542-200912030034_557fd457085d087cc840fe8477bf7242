package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomListCtrl implements IViewCtrl
   {
      ...
      private static const const_1012:int = 267;
      
      private static const const_1013:int = 70;
      
      private static const const_1011:int = -70;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_277,_loc2_.tag);
         }
         ...
         else if(_loc2_.flatCategoryId > 0)
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_235,Tabs.const_354,"" + _loc2_.flatCategoryId,MainViewCtrl.const_676);
         }
         else
         {
      ...
      private function refreshPublicSpaceImage(param1:IWindowContainer, param2:OfficialRoomEntryData, param3:IBitmapWrapperWindow) : void
      {
         ...
         param3.x = !!param2.showDetails ? int(const_1011) : 0;
         param3.width = 274;
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1013) : int(const_1012);
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_653 || param2.type == OfficialRoomEntryData.TYPE_PUBLIC_SPACE))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            var_1787.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
