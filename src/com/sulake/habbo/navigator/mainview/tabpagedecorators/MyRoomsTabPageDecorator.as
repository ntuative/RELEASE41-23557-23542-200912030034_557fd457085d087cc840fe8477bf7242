package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_432:IDropMenuWindow;
      
      private var var_2236:IWindowContainer;
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_613;
         }
         if(param1 == 2)
         {
            return Tabs.const_594;
         }
         if(param1 == 3)
         {
            return Tabs.const_673;
         }
         if(param1 == 4)
         {
            return Tabs.const_523;
         }
         return Tabs.const_211;
      }
      
      private function startSearch() : void
      {
         var _loc1_:int = var_432 == null ? 0 : int(var_432.selection);
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_432 == null)
         {
            var_432 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            var_432.procedure = onChangeSubNavi;
            prepareSubNavi();
         }
         _loc3_.visible = true;
      }
