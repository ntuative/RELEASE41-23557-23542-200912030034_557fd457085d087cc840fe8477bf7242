package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      private var var_2250:IButtonWindow;
      
      private var var_584:TextFieldManager;
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2198 = param2;
         var_584 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_584.getText();
         if(_loc1_ == "")
         {
            return;
         }
         _navigator.mainViewCtrl.startSearch(Tabs.const_215,Tabs.const_197,_loc1_);
      }
   }
}
