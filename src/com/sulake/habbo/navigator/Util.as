package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1424:CutToHeight = new CutToHeight();
      
      private static var var_1425:CutToWidth = new CutToWidth();
      ...
      {
         var _loc4_:IWindow = param1.findChildByName(param2);
         _loc4_.setParamFlag(HabboWindowParam.const_34,true);
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1424.beforeSearch(param2,param1,param3);
         binarySearch(var_1424,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1425.beforeSearch(param2,param1,param3);
         binarySearch(var_1425,param2.length - 1);
      }
   }
}
