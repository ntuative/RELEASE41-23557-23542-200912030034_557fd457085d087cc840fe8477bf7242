package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2240:Dictionary;
      ...
      private var var_1729:ISessionDataManager;
      
      private var var_1731:RoomCreateViewCtrl;
      
      private var var_1728:RoomThumbnailRenderer;
      
      private var var_198:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1109:RoomInfoViewCtrl;
      
      private var var_72:IHabboCatalog;
      
      private var var_389:Tabs;
      
      private var var_436:MainViewCtrl;
      
      private var var_1730:Array;
      
      private var var_897:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_436 = new MainViewCtrl(this);
         var_1109 = new RoomInfoViewCtrl(this);
         var_1731 = new RoomCreateViewCtrl(this);
         var_1728 = new RoomThumbnailRenderer(this);
         var_897 = new GuestRoomPasswordInput(this);
         var_330 = new GuestRoomDoorbell(this);
         var_389 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_436.startSearch(Tabs.const_215,Tabs.const_277,param1);
         var_436.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_198 != null)
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_198 != null)
         {
            var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1729 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_436.startSearch(Tabs.const_258,Tabs.const_211);
         var_389.getTab(Tabs.const_258).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_436.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
