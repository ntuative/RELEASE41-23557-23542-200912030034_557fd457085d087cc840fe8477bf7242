package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_738:TextFieldManager;
      
      private var var_1350:IWindowContainer;
      
      private var var_1668:ITextWindow;
      
      private var var_371:IRoomSettingsCtrlOwner;
      ...
      {
         close();
         this.var_371.roomSettingsRefreshNeeded();
      }
      ...
      private function clearErrors() : void
      {
         ...
         this.var_738.clearErrors();
         this.var_739.clearErrors();
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         close();
         var_371.roomSettingsRefreshNeeded();
         ...
         _navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_161,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + var_372);
         _navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",var_76.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(_navigator.getXmlWindow("ros_room_delete_confirm")),this,onConfirmRoomDelete,[var_372]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,100,20)));
      }
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1350.visible = _inRoom;
         var_1348.visible = _inRoom;
         var_1669.visible = var_433;
         var_1668.visible = !var_433;
         if(var_433)
         {
            var_899.visible = true;
            var_1085.visible = false;
            refreshFlatControllers();
            var_899.height = Util.getLowestPoint(this.var_899) + 4;
         }
         else
         {
            populateForm();
            ...
            var_1088.visible = _inRoom;
            _navigator.thumbRenderer.refreshThumbnail(IWindowContainer(var_1088.findChildByName("picframe")),_navigator.data.enteredGuestRoom.thumbnail,false);
            var_900.height = Util.getLowestPoint(this.var_900) + 4;
         }
         var_1349.text = !!var_433 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1350.name,var_1088.name,var_900.name,var_899.name,var_1085.name,var_1348.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         var_1089.setText(_loc1_.description);
         var_897.setText("");
         var_1090.setText("");
         ...
         setTag(var_738,_loc1_.tags[0]);
         setTag(var_739,_loc1_.tags[1]);
         if(var_1087)
         {
            if(_loc1_.allowPets)
            {
      ...
      {
         this.var_372 = param1;
         _navigator.send(new GetRoomSettingsMessageComposer(var_372));
         if(var_901 != null)
         {
            var_901.visible = false;
         }
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.description = var_1089.getText();
         ...
         {
            _loc8_ = var_897.getText();
            _loc9_ = var_1090.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_897.clearErrors();
               this.var_1090.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1087.isSelected;
         _loc2_.allowFoodConsume = var_1086.isSelected;
         ...
         addTag(var_738,_loc2_.tags);
         addTag(var_739,_loc2_.tags);
         this.clearErrors();
         this.var_898 = _loc2_.roomId;
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.send(new RemoveAllRightsMessageComposer(this.var_372));
      }
      
      public function onRoomSettingsSaved(param1:int) : void
      {
         if(param1 != this.var_372 || var_898 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         var_898 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1184)
         {
            this.var_721.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1158)
         {
         ...
         {
            setTagError(this.var_738,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_739,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1237)
         {
            setTagError(this.var_738,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_739,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1321)
         {
            this.var_897.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_652,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_842,onDoorModePasswordUnselect);
         ...
         this.var_1089 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_738 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_739 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_897 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1090 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1087 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         this.var_1086 = ICheckBoxWindow(_window.findChildByName("allow_foodconsume_checkbox"));
         var_1350 = IWindowContainer(_window.findChildByName("header_container"));
         var_1088 = IWindowContainer(_window.findChildByName("thumbnail_container"));
         var_900 = IWindowContainer(_window.findChildByName("basic_settings_container"));
         var_899 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         var_1348 = IWindowContainer(_window.findChildByName("switch_view_container"));
         var_1085 = IWindowContainer(_window.findChildByName("footer_container"));
         var_246 = IWindowContainer(_window.findChildByName("flat_controllers_container"));
         var_901 = IWindowContainer(_window.findChildByName("password_container"));
         var_1668 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1669 = ITextWindow(_window.findChildByName("advanced_caption"));
         var_1349 = ITextWindow(_window.findChildByName("switch_view_text"));
         var_1349.procedure = onSwitchView;
         var_901.visible = false;
         if(!_inRoom)
         {
