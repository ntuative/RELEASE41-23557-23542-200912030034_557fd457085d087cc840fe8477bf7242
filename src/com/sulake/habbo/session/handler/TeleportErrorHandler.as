package com.sulake.habbo.session.handler
{
   ...
   public class TeleportErrorHandler extends BaseHandler
   {
      ...
      private function onDoorNotInstalledMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_802,_loc3_));
         }
      }
      ...
      private function onDoorOtherEndDeletedMessage(param1:IMessageEvent) : void
      {
         ...
         if(listener && false)
         {
            listener.events.dispatchEvent(new RoomSessionErrorMessageEvent(RoomSessionErrorMessageEvent.const_942,_loc3_));
         }
      }
   }
}
