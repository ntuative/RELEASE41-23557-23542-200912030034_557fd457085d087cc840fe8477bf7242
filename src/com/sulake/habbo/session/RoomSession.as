package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_920:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_280 && _connection != null)
         {
            _state = RoomSessionEvent.const_89;
            if(isPrivateRoom)
            {
      ...
      {
         return var_920 as IUserDataManager;
      }
