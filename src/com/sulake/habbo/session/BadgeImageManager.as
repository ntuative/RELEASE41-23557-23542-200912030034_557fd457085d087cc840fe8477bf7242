package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1108:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_791:String = "group_badge";
       
      
      private const const_1369:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1369,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1369 + param1;
         ...
         switch(param2)
         {
            case const_1108:
               if(var_175 != null)
               {
                  _loc5_ = var_175.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_791:
               if(var_175 != null)
               {
                  if(var_175 != null)
                  {
                     _loc5_ = var_175.getKey("group.badge.url");
