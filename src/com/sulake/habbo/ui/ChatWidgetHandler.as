package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_452:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_129];
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_451 != null)
         {
            ...
            {
               _loc2_ = var_451.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_129:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_451.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_636.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_325:
                                       _loc16_ = _container.avatarRenderManager.createPetImage(_loc15_,AvatarScaleType.const_95);
                                       if(_loc16_ != null)
                                       {
                                       ...
                                       break;
                                    default:
                                       _loc16_ = _container.avatarRenderManager.createAvatarImage(_loc15_,AvatarScaleType.const_95);
                                       if(_loc16_ != null)
                                       {
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_451.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_636.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_665,RoomWidgetChatSelectAvatarMessage.const_579];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_665:
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_129,_container.roomSession,0,"Version 23557-23542-200912030010");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_291);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_463);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                     ...
                     switch(_loc3_.chatType)
                     {
                        ...
                        case RoomWidgetChatMessage.const_98:
                           ...
                           break;
                        case RoomWidgetChatMessage.const_109:
                           _container.roomSession.sendWhisperMessage(_loc3_.recipientName,_loc3_.text);
                     }
                  }
               }
               break;
            case RoomWidgetChatSelectAvatarMessage.const_579:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_764 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_764);
            }
            if(var_452 == null)
            {
               var_453.x = 0;
               var_453.y = 0;
               var_453.z = 0;
               var_452 = _loc4_.getScreenPoint(var_453);
               var_764 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_453.x = 0;
            var_453.y = 0;
            var_453.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_453);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_452.x || _loc8_.y != var_452.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_452,_loc5_));
      ...
      {
         return RoomWidgetEnum.const_324;
      }
