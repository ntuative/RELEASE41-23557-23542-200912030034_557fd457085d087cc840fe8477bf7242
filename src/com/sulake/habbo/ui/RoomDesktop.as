package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_229:DesktopLayoutManager;
      ...
      private var var_1999:IHabboHelp = null;
      ...
      private var var_805:IRoomWidgetFactory = null;
      ...
      private var var_1244:IAvatarRenderManager = null;
      ...
      private var var_521:ISessionDataManager = null;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_228 = new Map();
         var_229 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_421,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_362,onRoomContentLoaded);
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_686,onRoomContentLoaded);
         }
      }
      ...
      public function init() : void
      {
         ...
         {
            var_678 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         {
            var_1259 = !var_474.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_270[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_228.length)
            {
               _loc5_ = var_228.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_421,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_362,onRoomContentLoaded);
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_686,onRoomContentLoaded);
         }
         _roomEngine = null;
         var_34 = null;
         var_805 = null;
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_2069);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_228.length)
         {
            _loc2_ = var_228.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_229.setLayout(param1,_windowManager);
         if(var_198 != null)
         {
            var_229.toolbarSize = var_198.size;
            var_229.toolbarOrientation = var_198.orientation;
         }
      }
      ...
      public function canvasMouseHandler(param1:Event) : void
      {
         ...
         if(_loc4_ == _loc2_.target)
         {
            ...
            _roomEngine.handleRoomCanvasMouseEvent(var_270[0],_loc6_,_loc7_,_loc3_,_loc2_.altKey,_loc2_.ctrlKey,_loc2_.shiftKey,_loc2_.buttonDown);
         }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_805.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_229.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_228.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_229.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_229 != null)
         {
            var_229.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_708:
               _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_316,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               if(var_1468 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_47.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_396)
                  {
                     var_1468.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            case RoomEngineObjectEvent.const_222:
               switch(_loc3_)
               {
            ...
            case RoomEngineObjectEvent.const_521:
               ...
               break;
            case RoomEngineObjectEvent.const_474:
            ...
            case RoomEngineObjectEvent.const_104:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_571,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_111:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_618,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_ECOTRONBOX:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_602,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
            ...
            case RoomEngineObjectEvent.const_384:
               handleRoomAdTooltip(param1);
               break;
            case RoomEngineObjectEvent.const_84:
               processEvent(param1);
         }
         if(_loc4_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_228.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_229.roomViewRect;
         var _loc3_:int = _loc2_.width;
         var _loc4_:int = _loc2_.height;
         var _loc5_:int = 0;
         if(var_270.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_638);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_701);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_711);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_518);
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.iconId == HabboToolbarIconEnum.ZOOM)
         {
            if(var_47 != null)
            {
               ...
               {
                  _loc2_.performZoom();
                  _loc3_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_163,HabboToolbarIconEnum.ZOOM);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_311);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_383:
               ...
               var_177 = _windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_234,WindowParam.const_80) as IToolTipWindow;
               var_177.setParamFlag(WindowParam.const_45,false);
      ...
      {
         if(var_678 == null || false)
         {
            return;
         }
         var _loc2_:int = var_678.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_678.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_34 != null && var_47 != null && var_1259 && var_9)
         {
      ...
      {
         var _loc3_:IWindowContainer = var_229.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
         ...
         var _loc6_:int = ColorConverter.method_7(param1);
