package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      protected static const const_726:String = "default";
      ...
      private function parseTextures(param1:XML, param2:IGraphicAssetCollection) : void
      {
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            {
               _loc6_ = _loc5_.@id;
               if(var_173.getValue(_loc6_) == null)
               {
      ...
      public function dispose() : void
      {
         ...
         if(var_173 != null)
         {
            ...
            {
               _loc3_ = var_173.getWithIndex(_loc1_) as PlaneTexture;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         return var_173.getValue(param1) as PlaneTexture;
      }
