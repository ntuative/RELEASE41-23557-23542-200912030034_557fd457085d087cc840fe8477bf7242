package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1415:int = 16777216;
      
      public static const const_1440:int = 1;
       
      
      private var var_2227:int = 69069;
      
      private var var_1145:int = 1;
      
      private var var_2228:int = 5;
      
      private var var_1401:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1401 * param2);
      }
      ...
      {
         var _loc1_:int = var_2227 * var_1145 + var_2228;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
