package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterial
   {
      ...
      private function method_5(param1:IVector3d) : PlaneMaterialCellMatrix
      {
         var _loc3_:* = null;
         if(param1 == null)
         {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_426.length)
         {
            _loc3_ = var_426[_loc2_] as PlaneMaterialCellMatrix;
            if(_loc3_ != null)
            {
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         var _loc8_:PlaneMaterialCellMatrix = method_5(param4);
         if(_loc8_ != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_426.length)
            {
               _loc2_ = var_426[_loc1_] as PlaneMaterialCellMatrix;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
