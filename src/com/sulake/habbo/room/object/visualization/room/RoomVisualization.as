package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1257:int = 13421772;
      
      private static const const_1091:int = 16777215;
      
      public static const const_1180:int = 10066329;
      
      private static const const_1092:int = 13421772;
      
      public static const const_1282:int = 16777215;
      
      private static const const_1377:int = 0;
      
      public static const const_1239:int = 16777215;
      
      private static const const_1090:int = 10066329;
      
      private static const const_1089:int = 10066329;
      
      public static const const_1123:int = 13421772;
      ...
      private var var_1198:String = null;
      
      private var var_2117:Boolean = true;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            _loc8_ = var_111[_loc4_] as RoomPlane;
            if(_loc8_ != null)
            {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1442;
               }
               if(var_86.getPlaneType(_loc4_) == RoomPlaneData.const_142)
               {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            _loc3_ = var_111[_loc2_] as RoomPlane;
            _loc4_ = getSprite(1 + _loc2_);
            if(_loc4_ != null && _loc3_ != null && _loc3_.leftSide != null && _loc3_.rightSide != null)
            {
               if(_loc3_.type == RoomPlane.const_220 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_533);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_719);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_723);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_906);
            if(_loc8_ != var_2116)
            {
               updatePlaneMasks(_loc8_);
               var_2116 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_570));
            if(_loc9_ != var_1015)
            {
               var_1015 = _loc9_;
            }
            var_2117 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_873));
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            _loc11_ = var_111[_loc4_] as RoomPlane;
            if(_loc10_ != null && _loc11_ != null && _loc11_.type != RoomPlane.const_180)
            {
               _loc12_ = uint(_loc11_.color);
               if(var_2117)
               {
                  _loc13_ = uint((_loc12_ & 255) * (var_1015 & 255) / 255);
                  _loc14_ = uint((_loc12_ >> 8 & 255) * (var_1015 >> 8 & 255) / 255);
                  _loc15_ = uint((_loc12_ >> 16 & 255) * (var_1015 >> 16 & 255) / 255);
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_936);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_981);
         var _loc7_:int = 0;
         while(_loc7_ < var_86.planeCount)
         {
            ...
            _loc13_ = null;
            if(_loc12_ == RoomPlaneData.const_142)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_179,true,_loc11_,_loc6_);
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1282;
               }
               else
               {
                  _loc13_.color = const_1257;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_141)
            {
               ...
               {
                  _loc13_.color = const_1089;
               }
               else if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1091;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1092;
               }
               else
               {
                  _loc13_.color = const_1090;
               }
               if(_data != null)
               {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_180,true,_loc11_,_loc6_,_loc5_,0,_loc3_,_loc4_);
               if(_loc14_.y > 0)
               {
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_111.length)
            {
               _loc2_ = var_111[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_111.length)
         {
            _loc5_ = var_111[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_179 && param1 != null)
               {
                  _loc5_.id = param1;
               }
               else if(_loc5_.type == RoomPlane.const_220 && param2 != null)
               {
                  _loc5_.id = param2;
               }
               else if(_loc5_.type == RoomPlane.const_180 && param3 != null)
               {
                  _loc5_.id = param3;
               }
            }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         while(_loc4_ < var_111.length)
         {
            _loc3_ = var_111[_loc4_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            {
               _loc9_ = 0;
               while(_loc9_ < var_111.length)
               {
                  _loc3_ = var_111[_loc9_] as RoomPlane;
                  if(_loc3_.type == RoomPlane.const_220 || _loc3_.type == RoomPlane.const_180 && _loc8_ == RoomPlaneBitmapMaskData.const_192)
                  {
