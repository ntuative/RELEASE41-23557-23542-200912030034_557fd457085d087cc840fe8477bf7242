package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1367:int = 0;
      
      private var var_543:String;
      
      private var var_583:int = 0;
      
      private const const_1567:int = 1;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = var_394.getValue(_loc4_) as IAvatarImage;
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_162);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_563);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_610);
         ...
         var _loc13_:Number = _loc7_ - var_1213;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_288);
         if(_loc15_ > 0)
         {
         ...
         var _loc19_:Boolean = var_276 != _loc2_.getUpdateID() || var_207 != param1.scale || var_185 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_467 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_467;
            _loc22_ = getTimer();
            if(var_543 != _loc6_)
            {
               for each(_loc48_ in var_394.getKeys())
               {
                  var_394.remove(_loc48_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            {
               ...
               var_394.remove(_loc4_);
               var_394.add(_loc4_,_loc5_);
               var_543 = _loc6_;
            }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_296);
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_240) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_240);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_588);
            _loc5_.appendAction(AvatarAction.const_576,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_442);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_385);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_274,AvatarAction.const_1328[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_916);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_844,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_877);
            if(_loc30_ > 0)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_794,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_559);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_568);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_961,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_815);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_768,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_380);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_376) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_578);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_444);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_866);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_675,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1566);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_799))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
            ...
            var_790.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_790)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_394 != null)
         {
            _loc1_ = var_394.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_394.getValue(_loc2_) as IAvatarImage;
               _loc3_.dispose();
            }
         }
