package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private var var_789:PetVisualizationData = null;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_912);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_827)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_963);
               var_467 = const_1040;
            }
         }
         ...
         var _loc14_:Boolean = var_276 != _loc2_.getUpdateID() || var_207 != param1.scale || var_185 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_467 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_467;
            if(var_543 != _loc6_)
            {
               for each(_loc35_ in var_394.getKeys())
               {
                  var_394.remove(_loc35_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_296);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_240);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_588);
            _loc5_.appendAction(AvatarAction.const_576,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_442);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc37_ = _loc3_.getNumber(RoomObjectVariableEnum.const_385);
               _loc38_ = 3;
               _loc39_ = _loc7_ - _loc37_;
               if(_loc39_ < _loc38_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_274,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_376) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1041;
            ...
            _loc30_ = getSprite(const_1566);
            if(_loc9_ > 0)
            {
               _loc28_ = null;
               _loc28_ = var_789.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
            ...
            var_790.push(getTimer() - _loc17_);
            if(false)
            {
               _loc55_ = 0;
               _loc56_ = "[";
               for each(_loc57_ in var_790)
               {
                  _loc55_ += _loc57_;
                  _loc56_ += "," + _loc57_;
               }
      ...
      {
         var_789 = param1 as PetVisualizationData;
         createSprites(4);
         return true;
      }
