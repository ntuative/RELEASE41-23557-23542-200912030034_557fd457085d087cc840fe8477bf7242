   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_111.length)
         {
            ...
            _loc8_ = var_111[_loc4_] as FurniturePlane;
            if(_loc8_ != null)
            {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + _loc2_.getInstanceId() + "_" + var_1442;
               }
      ...
      override public function dispose() : void
      {
         ...
         if(var_111 != null)
         {
            ...
            {
               _loc2_ = var_111[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_305);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_472);
