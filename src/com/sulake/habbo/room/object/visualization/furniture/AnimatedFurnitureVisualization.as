      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1264,var_461,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1264,_loc6_,_loc5_.activeSequenceOffset + 1,var_461,param1);
               }
