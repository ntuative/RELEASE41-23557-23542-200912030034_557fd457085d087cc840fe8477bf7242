package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_317:int = 1000;
      ...
      private var var_1134:int = 360;
      
      private var var_1762:int = 0;
      
      private var var_624:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1134 / 2) % 360 / var_1134;
         if(var_215.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_215.length)
         {
            _loc6_ = int(var_215.getKey(_loc5_)) * var_1134;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_215.getKey(_loc4_));
         }
         return const_1198;
      }
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_808);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_796);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_215.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_215 != null)
         {
            ...
            {
               _loc2_ = var_215.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_215.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_215.add(String(_loc7_),_loc3_);
            var_1133 = -1;
            var_624 = null;
            _loc5_++;
         }
