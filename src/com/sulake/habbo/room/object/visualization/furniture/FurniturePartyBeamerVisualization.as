package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_748:int = 15;
      
      private static const const_1023:int = 2;
      
      private static const const_341:int = 2;
      
      private static const const_749:int = 31;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_954[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_953[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_954 = new Array();
         var_954.push(Math.random() * _loc2_ * 1.5);
         var_954.push(Math.random() * _loc2_ * 1.5);
         var_955 = new Array();
         var_955.push(1);
         var_955.push(-1);
         var_956 = new Array();
         var_956.push(const_1023);
         var_956.push(const_1024);
         var_953 = new Array();
         var_953.push(getRandomAmplitudeFactor());
         var_953.push(getRandomAmplitudeFactor());
      }
