package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1001:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_514:
                  _loc2_.setString(RoomObjectVariableEnum.const_719,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_635:
                  _loc2_.setString(RoomObjectVariableEnum.const_533,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_508:
                  _loc2_.setString(RoomObjectVariableEnum.const_723,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_387:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_192)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_547:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_906,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_873,int(_loc5_.bgOnly));
            var_1267 = _color;
            var_1491 = var_1054;
            var_1001 = _loc11_;
            var_1493 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_936,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_570,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc7_.x >= 0 && _loc7_.x < _loc14_ && _loc7_.y >= 0 && _loc7_.y < _loc15_)
         {
            ...
            _loc4_.setNumber(RoomObjectVariableEnum.const_1164,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1301,_loc22_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_142)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_141 || _loc13_ == RoomPlaneData.const_268)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_829)
         {
            ...
            {
               _loc6_ = var_1267 >> 16 & 255;
               _loc7_ = var_1267 >> 8 & 255;
               _loc8_ = var_1267 & 255;
               _loc9_ = var_1001 >> 16 & 255;
               _loc10_ = var_1001 >> 8 & 255;
               _loc11_ = var_1001 & 255;
               _loc12_ = (_loc1_ - var_829) / var_1492;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1491 + (var_1493 - var_1491) * _loc12_;
               _color = _loc2_;
               var_1054 = _loc3_;
            }
            _loc4_ = ColorConverter.method_7(_loc2_);
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_570,_loc2_);
         }
      }
   }
}
