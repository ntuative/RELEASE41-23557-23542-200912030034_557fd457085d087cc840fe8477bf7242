package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureRoomDimmerLogic extends FurnitureLogic
   {
      ...
      override public function update() : void
      {
         ...
         {
            _loc1_ = object.getModelController().getString(RoomObjectVariableEnum.const_144);
            if(_loc1_ != null && _loc1_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_144,"");
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_113,_loc3_,_loc4_);
      ...
      override public function dispose() : void
      {
         ...
         if(var_1248)
         {
            if(eventDispatcher != null && object != null)
            {
               ...
               _loc7_ = new RoomObjectWidgetRequestEvent(RoomObjectWidgetRequestEvent.const_84,_loc1_,_loc2_);
