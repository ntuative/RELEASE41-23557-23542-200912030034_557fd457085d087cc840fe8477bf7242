package com.sulake.habbo.room.object
{
   ...
   public class RoomObjectVisualizationFactory extends Component implements IRoomObjectVisualizationFactory
   {
      ...
      private var var_762:IAvatarRenderManager = null;
      ...
      public function getRoomObjectVisualizationData(param1:String, param2:String, param3:XML) : IRoomObjectVisualizationData
      {
         ...
         var _loc8_:* = null;
         var _loc4_:* = null;
         _loc4_ = var_449.getValue(param1) as IRoomObjectVisualizationData;
         if(_loc4_ != null)
         {
            return _loc4_;
         }
         ...
         switch(param2)
         {
            ...
            case RoomObjectVisualizationEnum.const_233:
               ...
               break;
            case RoomObjectVisualizationEnum.const_152:
            ...
            case RoomObjectVisualizationEnum.const_854:
            case RoomObjectVisualizationEnum.const_224:
            case RoomObjectVisualizationEnum.const_900:
            ...
            case RoomObjectVisualizationEnum.const_227:
               _loc5_ = FurnitureVisualizationData;
               break;
            case RoomObjectVisualizationEnum.const_253:
               _loc5_ = AnimatedFurnitureVisualizationData;
         }
         if(_loc5_ == null)
         {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc6_ is AvatarVisualizationData)
            {
               ...
               _loc7_.avatarRenderer = var_762;
            }
            else if(_loc6_ is PetVisualizationData)
            {
               _loc8_ = _loc4_ as PetVisualizationData;
               _loc8_.avatarRenderer = var_762;
            }
            var_449.add(param1,_loc6_);
            return _loc6_;
         }
         return null;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_449 != null)
         {
            ...
            {
               _loc1_ = var_449.getWithIndex(_loc2_) as IRoomObjectVisualizationData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      private function avatarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_762 = param2 as IAvatarRenderManager;
      }
