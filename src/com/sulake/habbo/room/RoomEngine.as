package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_481:String = "room";
      
      private static const const_758:int = -2;
      
      private static const const_482:String = "temporary_room";
      
      private static const const_270:String = "object_icon_sprite";
      
      private static const const_760:int = -3;
      
      private static const const_759:String = "overlay";
      
      private static const OBJECT_TYPE_SELECTION_ARROW:String = "selection_arrow";
      
      private static const const_1063:String = "tile_cursor";
      
      private static const const_271:int = -1;
       
      
      private var var_380:IRoomObjectVisualizationFactory = null;
      
      private var var_478:Boolean = false;
      ...
      private var var_557:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_295 = new Map();
         var_557 = new NumberBank(1000);
         var_991 = new Map();
         var_296 = new Map();
         var_70 = new RoomObjectEventHandler(this);
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(var_70 != null)
         {
            ...
            {
               return var_70.deleteWallItem(var_120,var_119,param1);
            }
         }
         return false;
      }
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_638) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_711) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_701) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_518) + 0.5;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_144);
            if(_loc7_ != null)
            {
      ...
      public function selectRoomObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         var_70.setSelectedObject(param1,param2,param3,param4);
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_29)
            {
               return var_70.modifyWallItemData(var_120,var_119,param1,param3);
            }
         }
         return false;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_380 != null)
         {
            var_380.release(new IIDRoomObjectVisualizationFactory());
            var_380 = null;
         }
         if(var_48 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_825;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_662);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_641);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_666);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_901);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_788);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_772) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_946);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_387,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_547,_loc5_);
                  }
               }
            }
         }
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_521,var_120,var_119,param2,param3));
            }
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(var_70 != null)
         {
            return var_70.modifyRoomObject(var_120,var_119,param1,param2,param3);
         }
         return false;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = var_296.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               var_296.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_514,param3);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param4 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_635,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         if(param5 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_508,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc7_);
         }
         return true;
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_48 != null)
         {
            ...
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_35);
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_229);
            var_48.addObjectUpdateCategory(RoomObjectCategoryEnum.const_63);
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(var_70 != null)
         {
            var_70.handleRoomObjectEvent(param1,var_120,var_119);
         }
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_186,_loc10_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_326,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_311,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_857,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_222,param1,param2,param3,RoomObjectCategoryEnum.const_33));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_380 == null || var_48 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2044)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_271,RoomObjectCategoryEnum.const_63);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1264,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:IRoomInstance = var_48.getRoom(getRoomIdentifier(var_120,var_119));
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_760,RoomObjectCategoryEnum.const_229);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1252);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1252);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_380 = param2 as IRoomObjectVisualizationFactory;
         if(var_25 != null)
         {
            var_25.visualizationFactory = var_380;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_216,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_391,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_395,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_237,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_104,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_111,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_84,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_436,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_468,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_429,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_412,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_346,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_441,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_371,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_372,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_345,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_245,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_381,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_275,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_289,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_363,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_982,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_440,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(AvatarWalkWarpingWarningEvent.const_438,method_11);
            }
         }
      }
      ...
      {
         var _loc5_:IRoomInstance = getRoom(var_120,var_119);
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_499) != 0)
         {
            return false;
         }
         if(var_70 != null)
         {
            return var_70.initializeRoomObjectInsert(var_120,var_119,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            var_478 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_695,0,0));
            _loc2_ = 0;
            while(_loc2_ < var_296.length)
            {
               _loc3_ = var_296.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_222,param1,param2,param3,RoomObjectCategoryEnum.const_35));
         }
         return true;
      }
            ...
            if(_loc13_ != null && _loc13_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_29:
                     _loc10_ = String(_loc13_.getModel().getNumber(RoomObjectVariableEnum.const_186));
                     break;
                  case RoomObjectCategoryEnum.const_35:
                     _loc10_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_162);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_296);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_573)
         {
            var_2044 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_186,_loc10_,false);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_326,param4,true);
            _loc12_.getModelController().setString(RoomObjectVariableEnum.const_311,_loc11_,true);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_825,1,true);
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_222,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_474.events.addEventListener(AdEvent.const_370,showRoomAd);
      }
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_759) as Sprite;
      }
      ...
      public function selectAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         if(var_70 != null)
         {
            var_70.setSelectedAvatar(param1,param2,param3,param4);
         }
      }
      ...
      public function getSelectedAvatarId() : int
      {
         if(var_70 != null)
         {
            return var_70.getSelectedAvatarId();
         }
         return -1;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_565,param1,param2));
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0) : ImageResult
      {
         ...
         _loc8_.id = -1;
         if(!var_478 || param1 == null)
         {
            return _loc8_;
         }
         var _loc9_:IRoomInstance = var_48.getRoom(const_482);
         if(_loc9_ == null)
         {
            _loc9_ = var_48.createRoom(const_482,null);
            if(_loc9_ == null)
            {
               return _loc8_;
            }
         }
         var _loc10_:int = var_557.reserveNumber();
         ...
         switch(_loc11_)
         {
            case RoomObjectCategoryEnum.const_33:
            case RoomObjectCategoryEnum.const_29:
               _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_186,int(param2));
               break;
            case RoomObjectCategoryEnum.const_35:
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_162,param2);
               break;
            case RoomObjectCategoryEnum.const_63:
               if(param2 != null)
               {
                  ...
                  if(_loc16_.length >= 3)
                  {
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_141,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_141,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_268,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_ = _loc20_.getXML();
                     _loc12_.getEventHandler().initialize(_loc21_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_719,_loc17_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_533,_loc18_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_723,_loc19_);
                     if(param6 != null)
                     {
                        _loc22_ = null;
                        _loc23_ = "undefined_" + _loc10_;
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_387,_loc23_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_991.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_792,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            var_557.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_758,RoomObjectCategoryEnum.const_229);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,param1);
         if(_loc9_ != null)
         {
            var_1252 = param1;
            var_1486 = param2;
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1486 - _loc12_.width / 2;
               _loc11_.y = var_1485 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_474,var_120,var_119,-1,RoomObjectCategoryEnum.const_205));
                  }
                  _loc13_ = "null";
               }
               ...
               if(var_70 != null)
               {
                  _loc14_ = new RoomObjectMouseEvent(_loc13_,const_271,const_481);
                  var_70.handleRoomObjectEvent(_loc14_,var_120,var_119);
               }
            }
         }
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc6_ = getRoomObjectImage(var_120,var_119,param1,param2,new Vector3d(),1,null);
         }
         else if(var_25 != null)
         {
            _loc8_ = null;
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_120,var_119,var_1252);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1486 - _loc6_.data.width / 2;
               _loc11_.y = var_1485 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_25 != null)
         {
            ...
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_283,param1.image,true);
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_895,param1.adWarningL,true);
            var_25.addGraphicAsset(var_25.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_911,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_958,RoomObjectVariableEnum.const_283,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_25 != null)
         {
            _events.addEventListener(RoomContentLoader.const_573,onContentLoaderReady);
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(var_70 != null)
         {
            var_70.cancelRoomObjectInsert(var_120,var_119);
         }
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = var_48.getRoom(const_482);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_792);
               ...
               var_557.freeNumber(_loc10_ - 1);
               _loc13_ = var_991.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_120,var_119,const_271,RoomObjectCategoryEnum.const_63,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         var _loc8_:int = _loc8_ = RoomObjectCategoryEnum.const_63;
         var _loc9_:* = null;
         var _loc10_:* = 1;
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_499,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_952,_loc13_,true);
            if(var_25 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_271,const_481,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_499,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_662,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_638,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_701,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_711,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_518,_loc19_);
               _loc14_ += _loc16_ * 423 + _loc17_ * 671 + _loc18_ * 913 + _loc19_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_981,_loc14_,true);
               }
            }
         }
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_514,param3);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param4 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_635,param4);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param5 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_508,param5);
            _loc9_.getEventHandler().processUpdateMessage(_loc11_);
         }
         if(param2 != null)
         {
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_387,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_192);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_641,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_666,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_641,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_666,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_901,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_788,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_758,const_1063,RoomObjectCategoryEnum.const_229);
         _loc7_.createRoomObject(const_760,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_229);
         return _loc7_;
      }
