package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_732:String = "tile_cursor";
      
      private static const const_269:String = "RCL_PUBLICROOM_";
      ...
      private static const const_997:String = const_333;
      
      private static const const_1353:int = 0;
      
      private static const const_731:int = 1;
      
      private static const ROOM_CONTENT:String = "room";
      
      public static const const_573:String = "RCL_LOADER_READY";
      ...
      private var var_883:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         ...
         var_1536 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_363 = new Map();
         _events = new Map();
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         while(_loc5_ < _loc3_.length())
         {
            ...
            _loc7_ = const_269 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_122 || param1 == RoomObjectVisualizationEnum.PET || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      {
         if(var_164 != null && var_164.hasWorldType(const_269 + param1))
         {
            return var_164.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_588.indexOf(_loc14_) < 0)
                              {
                                 var_588.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              if(var_589.indexOf(_loc14_) < 0)
                              {
                                 var_589.push(_loc14_);
                              }
                           }
                           _loc16_ = var_424.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_424.remove(_loc14_);
                              var_424.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_311 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_311.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_333,const_476,ROOM_CONTENT,const_732,const_733];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_500.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_33 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_424.getValue(param1));
         }
         return 0;
      }
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_152 && _loc5_ != RoomObjectLogicEnum.const_122)
         {
            _loc6_ = "@shadow";
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_364 != null)
         {
            _loc2_ = var_364.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1103);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_501.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1536.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_362,_loc5_);
         }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         {
            return RoomObjectCategoryEnum.const_229;
         }
         return RoomObjectCategoryEnum.const_205;
      }
      ...
      private function continueInitilization() : void
      {
         if(var_1541)
         {
            ...
            if(var_883 != null)
            {
               var_883.dispatchEvent(new Event(const_573));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_164 != null)
         {
            return var_164.getWorldHeightScale(const_269 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_883 = param1;
            var_1537 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1539 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1535 = param2.getKey("public.room.dynamic.download.url","");
            var_1540 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_731;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_311.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(var_364 != null)
         {
            ...
            var_364.add(param1,param2);
         }
         if(var_362 != null)
         {
            var_362.remove(param2);
            var_362.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_152 && _loc5_ != RoomObjectVisualizationEnum.const_122)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_380.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            var_311.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         if(getObjectCategory(const_269 + param1) == RoomObjectCategoryEnum.const_63)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_399,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_164 != null)
         {
            return var_164.getWorldScale(const_269 + param1);
         }
         return 32;
      }
