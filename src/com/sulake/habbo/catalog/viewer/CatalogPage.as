package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1343:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1291:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_719:String;
      
      private var var_1081:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_820:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_719);
      }
      ...
      {
         var _loc2_:String = const_1343 + param1;
         ...
         var_1291 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1291) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1099) as IWindowContainer;
         if(_loc1_ != null)
         {
            _widgets.push(new ProductViewCatalogWidget(_loc1_));
         }
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1171) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1081;
            _loc2_.init();
         }
         var_1081.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1081.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_719);
      }
