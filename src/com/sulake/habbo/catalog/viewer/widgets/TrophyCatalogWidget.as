package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_397.getWithIndex(var_199);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_471);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_397.getValue(_loc6_) == null)
            {
               var_397.add(_loc6_,new Map());
            }
            _loc8_ = var_397.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_397.getWithIndex(var_199);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_471);
            if(_loc3_ == null)
            {
