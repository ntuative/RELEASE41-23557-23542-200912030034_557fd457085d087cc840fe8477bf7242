package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_284 != null)
         {
            _loc2_ = var_284.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1131 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_284 = null;
         for each(_loc1_ in var_1130)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1131) as IWindowContainer;
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_623.width,var_623.height,true,0);
               _loc3_.bitmap.copyPixels(var_623,var_623.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1129.width,var_1129.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_921.width,var_921.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_921,var_921.rect,new Point(0,0),null,null,true);
