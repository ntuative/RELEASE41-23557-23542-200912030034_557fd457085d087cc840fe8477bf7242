package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_879:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_879 != null)
         {
            var_879.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_878 != null)
         {
            var_878.removeEventListener(WindowKeyboardEvent.const_128,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_879 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_879 != null)
         {
            var_879.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_878 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_878 != null)
         {
            var_878.addEventListener(WindowKeyboardEvent.const_128,windowKeyEventProcessor);
         }
      }
