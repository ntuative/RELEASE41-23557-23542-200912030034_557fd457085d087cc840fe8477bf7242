package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1324:Point;
      
      private var var_1588:Array;
      
      private var var_510:IItemGridWindow;
      
      private var var_88:IBitmapWrapperWindow;
      
      private var var_1186:ITextWindow;
      
      private var var_1064:IScrollbarWindow;
      
      protected var var_1287:XML;
      
      private var var_1063:BitmapData;
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_349:
                  _loc4_ = var_1063.clone();
                  if(var_510 != null)
                  {
                     var_510.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_510,var_1064,var_1287);
                  }
                  break;
               case Offer.const_373:
                     ...
                     case ProductTypeEnum.const_300:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_274,AvatarAction.const_622);
                              _loc13_.appendAction(AvatarAction.const_675,_loc6_.productClassId);
      ...
      override public function init() : void
      {
         ...
         var_1187 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_88 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1324 = new Point(var_88.x,var_88.y);
         var_510 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1064 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_510 == null)
         {
         ...
         var_1063 = _loc2_.content as BitmapData;
