package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_683:PurchaseConfirmationDialog;
      ...
      private var var_409:ICatalogNavigator;
      ...
      {
         return var_521.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2100 && var_804 != null)
         {
            var_804.playSound(HabboSoundTypesEnum.const_905);
         }
         var_2100 = false;
      }
      ...
      {
         return var_521.getFurnitureData(param1);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_93 == null)
         {
            return;
         }
         var_93.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_175.getKey("client.credits.embed.enabled"))
            {
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_89:
               var_1271 = param1.session.isPrivateRoom;
               if(var_93 != null)
               {
                  var_93.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_94:
               ...
               if(var_93 != null)
               {
                  var_93.setRoomSessionActive(false);
               }
         }
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_198.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
            _events.dispatchEvent(new Event(HabboCatalogTrackingEvent.HABBO_CATALOG_TRACKING_EVENT_OPEN));
            if(var_93 != null && getCurrentLayoutCode() == "recycler")
            {
               var_93.activate();
            }
         }
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_188,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_409 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      {
         var_93 = new RecyclerLogic(this,_windowManager);
         getRecyclerPrizes();
      }
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_683 == null)
            {
               var_683 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_683.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         var_93.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      {
         var_198.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_110,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_409.buildCatalogIndex(_loc2_);
         if(var_1010 != "")
         {
            var_409.openPage(var_1010);
            var_1010 = "";
         }
         else
         {
            var_409.openFrontPage();
         }
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_2099 && var_804 != null)
         {
            var_804.playSound(HabboSoundTypesEnum.const_774);
         }
         var_2099 = false;
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         var_93.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
