package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
      ...
      private var var_146:IItemListWindow;
      ...
      private var var_569:ITextWindow;
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_570)
               {
                  ...
                  HabboCatalog(var_72).purchaseProduct(var_642,var_180,var_1012,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_72).purchaseProduct(var_642,var_180,var_1012);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         var _loc20_:int = 0;
         var _loc21_:int = 0;
         _loc1_ = var_72.assets.getAssetByName("habbo_orderinfo_dialog") as XmlAsset;
         var _loc2_:XML = _loc1_.content as XML;
         if(_window == null)
         {
            _window = var_72.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_327,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
            _window.removeChildAt(-1);
         }
         var _loc3_:IWindowContainer = var_72.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc5_:int = var_72.getPurse().credits - 0;
         if(_loc5_ < 0)
         {
            _loc4_ = false;
         }
         if(var_570)
         {
            _loc6_ = var_72.assets.getAssetByName("habbo_orderinfo_gift_checked") as XmlAsset;
         }
         else
         {
            _loc6_ = var_72.assets.getAssetByName("habbo_orderinfo_gift_unchecked") as XmlAsset;
         }
         _loc2_ = _loc6_.content as XML;
         var _loc7_:IWindow = var_72.windowManager.buildFromXML(_loc2_) as IWindow;
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_698,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_652,onActivateGift);
         ...
         var _loc11_:IProductData = var_72.getProductData(var_180.localizationId);
         var _loc12_:String = _loc11_ == null ? "catalog.unknown.productname" : _loc11_.name;
         var_72.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","offer_name",_loc12_);
         var _loc13_:String = "";
         var _loc14_:String = "";
         var _loc15_:String = "";
         switch(var_180.priceType)
         {
            case Offer.const_308:
               _loc16_ = _localization.getLocalization("catalog.purchase.confirmation.dialog.price.credits");
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits","credits",var_180.priceInCredits.toString());
               _loc13_ = _loc16_.value;
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits","credits",var_72.getPurse().credits.toString());
               ...
               break;
            case Offer.const_502:
            case Offer.const_467:
               _loc16_ = _localization.getLocalization("catalog.purchase.confirmation.dialog.price.credits+pixels");
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","credits",var_180.priceInCredits.toString());
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","pixels",var_180.priceInPixels.toString());
               _loc13_ = _loc16_.value;
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","credits",var_72.getPurse().credits.toString());
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","pixels",var_72.getPurse().pixels.toString());
               _loc14_ = _loc16_.value;
               _loc19_ = var_72.getPurse().pixels - 0;
               _loc20_ = var_72.getPurse().credits - 0;
            ...
            case Offer.const_366:
               ...
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.pixels","pixels",var_180.priceInPixels.toString());
               _loc13_ = _loc16_.value;
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.pixels","pixels",var_72.getPurse().pixels.toString());
               _loc14_ = _loc16_.value;
               _loc21_ = var_72.getPurse().pixels - 0;
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.pixels","pixels",_loc21_.toString());
               _loc15_ = _loc16_.value;
               break;
            case Offer.const_818:
         ...
         var_72.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.costs","price",_loc13_);
         var_72.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.amount","amount",_loc14_);
         var_72.windowManager.registerLocalizationParameter("catalog.purchase.confirmation.dialog.remaining","remaining",_loc15_);
      ...
      private function updateSuggestions(param1:Array, param2:IWindow) : void
      {
         ...
         if(var_146 == null)
         {
            _loc5_ = var_72.assets.getAssetByName("habbo_orderinfo_receiver_suggestion") as XmlAsset;
            if(_loc5_ == null || _loc5_.content == null)
            {
               return;
            }
            var_146 = var_72.windowManager.buildFromXML(_loc5_.content as XML) as IItemListWindow;
            if(var_146 != null)
            {
               var_569 = var_146.getListItemAt(0) as ITextWindow;
               var_569.procedure = suggestionsEventHandler;
            }
         }
         if(var_146 == null || var_569 == null)
         {
            return;
         }
         var_146.removeListItems();
         if(param1.length == 0 || param1.length > 10)
         {
            var_146.visible = false;
            return;
         }
         var_146.visible = true;
         for each(_loc3_ in param1)
         {
            _loc6_ = var_569.clone() as ITextWindow;
            if(_loc6_ != null)
            {
               _loc6_.text = _loc3_;
               var_146.addListItem(_loc6_);
            }
         }
         _loc4_ = new Rectangle();
         param2.getGlobalRectangle(_loc4_);
         var_146.setGlobalPosition(new Point(_loc4_.left,_loc4_.bottom + 10));
      }
   }
}
