package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2225:String = "magic.pixels";
      
      private var var_2226:String = "catalog.page.club";
      
      private var var_2237:String = "magic.credits";
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_72.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = var_72.configuration.getKey("link.format.credits","/credits");
            var_72.windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
      ...
      {
         var_72.openCatalogPage(var_2226,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_245.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_245)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_245.indexOf(_loc6_);
            var_245.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(var_245.indexOf(param1) == -1)
         {
            var_245.push(param1);
         }
         var_72.loadCatalogPage(param1.pageId);
         var_72.events.dispatchEvent(new CatalogPageOpenedEvent(param1.pageId,param1.localization));
      }
      ...
      public function openFrontPage() : void
      {
         ...
         var_72.loadCatalogPage(_loc1_.pageId);
      }
      ...
      public function openPage(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            var_72.loadCatalogPage(_loc2_.pageId);
         }
         openNavigatorAtNode(_loc2_);
      }
      
      private function method_1(param1:NodeData, param2:int) : ICatalogNode
      {
         var _loc5_:* = null;
         ...
         {
            _loc4_.addChild(method_1(_loc5_,param2));
         }
         return _loc4_;
      }
   }
