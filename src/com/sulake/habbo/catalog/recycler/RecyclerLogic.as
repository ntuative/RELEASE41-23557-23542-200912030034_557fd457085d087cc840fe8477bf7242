package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_737:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1365)
         {
            case RecyclerStatusMessageEvent.const_1165:
               var_248 = const_334;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_770:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1162:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1365 != RecyclerStatusMessageEvent.const_770;
      }
      
      private function get statusActive() : Boolean
      {
         return var_248 != const_737;
      }
      ...
      {
         return active && var_248 == const_334;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_954:
               ...
               break;
            case RecyclerFinishedMessageEvent.const_1261:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_72.returnInventoryFurniFromRecycler(var_103[param1].id))
         {
            return;
         }
         var_103[param1] = null;
