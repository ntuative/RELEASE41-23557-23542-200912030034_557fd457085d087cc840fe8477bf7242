package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeLevelContainer
   {
      ...
      public function PrizeLevelContainer(param1:PrizeLevelMessageData, param2:IHabboCatalog)
      {
         ...
         var _loc6_:* = null;
         super();
         var_1132 = param1.prizeLevelId;
         param2.localization.registerParameter("recycler.prizes.odds." + var_1132,"odds","1:" + param1.probabilityDenominator);
         var_677 = new Array();
         var _loc3_:int = 0;
         while(_loc3_ < param1.prizes.length)
         {
            ...
            _loc6_ = new PrizeContainer(_loc4_.productItemType,_loc4_.productItemTypeId,_loc5_,var_1132);
            var_677.push(_loc6_);
            _loc3_++;
         }
      }
