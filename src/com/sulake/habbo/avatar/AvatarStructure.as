package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_410:PartSetsData;
      
      private var var_2105:PartOffsetData;
      ...
      private var var_161:IAssetLibrary;
      
      private var var_488:FigureData;
      
      private var var_2209:IAssetLibrary;
      
      private var var_1299:Boolean = false;
      
      private var var_685:AnimationManager;
      
      private var var_2104:AvatarRenderManager;
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_845)
         {
            case AvatarType.const_102:
               _loc3_ = var_161.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_410.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_161.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_161.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_488.parse(_loc5_))
               {
                  return;
               }
               var_1495.add(new AvatarStructureDownload(var_161,_loc2_,var_488));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_161.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_410.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_161.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_161.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_488.parse(_loc5_))
               {
                  return;
               }
      ...
      {
         var_846 = new AvatarActionManager(var_161,var_845);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_410.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_410.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc7_:Array = var_410.getActiveParts(param3.definition);
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_488.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_488.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_410.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_410.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_102:
               if(var_161.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_161.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_161.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_161.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_161.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_161.getAssetByName("dance" + _loc1_).content as XML;
            var_685.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_161.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_161.getAssetByName("fx" + _loc1_).content as XML;
            var_685.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         return var_2105.getOffset(param1,param2,param3,param4,param5,param6);
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_488.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_488.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_845 + " ready to go!");
         if(var_845 == AvatarType.const_102)
         {
            var_410.getPartDefinition("ri").appendToFigure = true;
            var_410.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
