package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1327:Number = 1;
      
      private var _b:uint;
      
      private var var_1328:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1326,var_1328,var_1327,_alphaMultiplier);
         var_892 = generatePaletteMapForGrayscale(var_1594,var_1596);
      }
      
      public function get reds() : Array
      {
         return var_892.getValue("reds") as Array;
      }
      ...
      {
         return var_892.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_892.getValue("greens") as Array;
      }
      ...
      {
         return var_892.getValue("alphas") as Array;
      }
