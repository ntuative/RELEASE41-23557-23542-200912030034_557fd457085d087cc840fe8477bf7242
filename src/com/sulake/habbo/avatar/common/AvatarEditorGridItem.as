package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1564:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1396:BitmapData;
      
      private const const_1563:int = 13421772;
      
      private var var_744:Rectangle;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         var_1396 = _loc7_.content as BitmapData;
         _color = param4;
         if(param3 == null)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_525 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1396,var_1396.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_744.width,var_744.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_807 + "_" + FigureData.const_262;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_926 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_807 + "_" + FigureData.const_262;
