package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_458:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1199 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_458 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_458.bitmap = new BitmapData(var_458.width,var_458.height,true,16777215);
         var_458.bitmap.copyPixels(var_1199,var_1199.rect,new Point(0,0 - 0 - 8));
         var_458.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
