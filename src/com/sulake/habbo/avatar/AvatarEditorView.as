package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1511:IWindowContainer;
      
      public static var var_1286:IWindowContainer;
      
      public static var var_1028:int = 6710886;
      ...
      private var var_1483:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1286 == null)
         {
            ...
            var_1286 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1511 == null)
         {
            _loc4_ = _controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1511 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
         var_166 = new Timer(1000);
         var_166.addEventListener(TimerEvent.TIMER,onUpdate);
      }
      ...
      public function updateAvatar() : void
      {
         ...
         if(var_653 != null)
         {
            toggleCategoryView(var_653,true);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1483 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_166.stop();
            var_166.removeEventListener(TimerEvent.TIMER,onUpdate);
            var_166 = null;
         }
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_653 = param1;
         var_1483.setSelected(var_1483.getSelectableByName(param1));
         _window.invalidate();
      }
