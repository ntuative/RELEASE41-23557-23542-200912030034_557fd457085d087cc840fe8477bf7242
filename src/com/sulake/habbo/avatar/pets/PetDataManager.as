package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_549.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_549.getValue(param1) as IPetData;
      }
      ...
      public function createAvatarFigureString(param1:String) : String
      {
         ...
         var _loc6_:PetData = var_549.getValue(_loc3_);
         if(_loc6_ == null)
         {
