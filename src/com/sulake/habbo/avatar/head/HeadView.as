package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_105,param2,param3);
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_135,param2,param3);
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_132,param2,param3);
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_127,param2,param3);
         attachImages();
