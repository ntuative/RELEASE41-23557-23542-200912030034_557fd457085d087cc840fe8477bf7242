package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_1361:PaletteManager;
      
      private var var_874:CoreComponent;
      
      private var var_1362:ILogger;
      
      private var var_1100:PetDataManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_518.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
         _loc2_ = var_518.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.init(_habboConfiguration);
         }
      ...
      {
         return var_1100 as IPetDataManager;
      }
      ...
      {
         var _loc3_:AvatarStructure = var_518.getValue(AvatarType.const_102) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
         return new AvatarImage(_loc3_,var_29,param1,param2,AvatarType.const_102);
      }
      
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         var _loc5_:String = var_1100.createAvatarFigureStringNew(param1,param2,param3);
         var _loc6_:AvatarStructure = var_518.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      private function onComponentsRunning(param1:Event = null) : void
      {
         ...
         var_1100 = new PetDataManager(_loc2_,_loc4_);
         var_1361 = new PaletteManager(_loc2_,_loc4_);
         var _loc5_:XML = _assets.getAssetByName("HabboAvatarPetFigure").content as XML;
         var_1100.populateFigureData(_loc5_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.const_102);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_518.add(AvatarType.const_102,_loc6_);
         _loc6_ = new AvatarStructure(this,assets,_loc2_,AvatarType.PET);
         _loc6_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_518.add(AvatarType.PET,_loc6_);
      ...
      {
         var _loc2_:AvatarStructure = var_518.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      private function paletteTest() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:PaletteMap = var_1361.getPalette(0);
