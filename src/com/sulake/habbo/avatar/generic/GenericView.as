package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_635["null"] = new AvatarEditorGridView(param1,FigureData.const_52,param2,param3);
         attachImages();
         switchCategory(FigureData.const_52);
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_92.categorySwitch(FigureData.const_81);
      ...
      {
         var _loc4_:AvatarEditorGridView = var_635[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var _loc4_:AvatarEditorGridView = var_635[var_1387];
         if(_loc4_ == null)
         {
            return;
         }
