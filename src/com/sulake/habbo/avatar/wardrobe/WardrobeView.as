package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_1338:IWindowContainer;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var _window:IWindowContainer;
      
      private var var_602:IItemListWindow;
      
      private var var_512:IItemListWindow;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_716:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_602 = _window.findChildByName("mylooks") as IItemListWindow;
         var_512 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_716 = _window.findChildByName("selector") as IItemListWindow;
         var_1338 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_92.controller.catalog.openCatalogPage(CatalogPageName.const_290,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_92.selectMyLook(var_602.getListItemIndex(param2.parent));
         }
      }
      ...
      private function initSelector() : void
      {
         ...
         {
            var_716.removeListItem(_loc1_.window);
            _loc1_.dispose();
         }
         var_511 = [];
         while(true)
         {
            ...
            var_716.addListItem(_loc1_.window);
      ...
      private function myLooksSelectorEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_716.getListItemIndex(param2);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_717 * 8 + var_512.getListItemIndex(param2.parent);
