package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      private var var_947:Dictionary;
      ...
      {
         (_context as CoreComponent).error("Could not load external variables. Client startup failed!",true,CoreComponent.const_1156);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_947[param1] as String;
         return _loc2_ != null;
      }
      ...
      private function onInitConfiguration(param1:Event = null) : void
      {
         ...
         var_839 = true;
         this.events.dispatchEvent(new Event(HabboConfigurationEvent.const_14));
         if(var_1838)
         {
      ...
      {
         var _loc4_:String = var_947[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1839);
