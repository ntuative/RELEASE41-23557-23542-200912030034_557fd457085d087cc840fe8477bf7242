package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1472:ICoreWindowManager;
      ...
      {
         var_1472 = param2 as ICoreWindowManager;
         _window = var_1472.create("Logger::Output",HabboWindowType.const_327,WindowStyle.const_234,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),method_10,"Logger") as IFrameWindow;
         var_332 = var_1472.create("Logger::Output::Text",HabboWindowType.const_1179,WindowStyle.const_234,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
