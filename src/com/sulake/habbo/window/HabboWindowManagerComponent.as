package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1029:uint = 1;
      ...
      private var var_1180:ProfilerAgentTask;
      
      private var var_1178:IEventDispatcher;
      
      private var var_2247:uint = 0;
      
      private var var_1181:ProfilerAgentTask;
      
      private var var_1179:ProfilerOutput;
      
      private var var_643:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1178 = Component(param1).events;
            var_781 = new Array();
      ...
      {
         return var_290[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_290[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_643 = new WindowRenderer(_loc4_);
         var_290 = new Array(const_340);
         var _loc6_:int = 0;
         while(_loc6_ < const_340)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_643,this,_localization,var_191,new Rectangle(0,0,var_191.stageWidth,var_191.stageHeight),this);
            var_290[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_404 = var_290[const_1029];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_404.getMouseCursor().defineCustomCursorType(MouseCursorType.const_329,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_404.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1316,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_290[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_290.pop()).dispose();
            }
            if(var_1179 != null)
            {
               var_1179.dispose();
      ...
      {
         return var_290[param1].getDesktopWindow().getChildAt(var_404.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1179 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1179 = new ProfilerOutput(_loc3_,this,var_643);
               var_1180 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1180);
               var_1181 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1181);
               var_965 = true;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_859.length > 0)
         {
            var_1178.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_340 - 1;
            while(_loc2_ >= 0)
            {
               var_290[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_965)
         ...
         var_1178.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_340)
         {
            var_290[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_965)
         {
         ...
         if(WindowContext.var_859.length > 0)
         {
            WindowContext.var_859.flush();
         }
         if(WindowContext.var_1285.length > 0)
         {
            WindowContext.var_1285.flush();
         }
         var_1178.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_781[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_781[0][param1] as XML : _loc4_;
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1125,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1291,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1218,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1119,param2.name + ": " + param2.toString());
            }
         }
      }
   }
