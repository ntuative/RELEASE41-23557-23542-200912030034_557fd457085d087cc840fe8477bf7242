package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      private var var_330:DoorbellWidget;
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_330.assets.getAssetByName("doorbell") as XmlAsset;
         var_57 = (var_330.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_57 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
         _list = var_57.findChildByName("user_list") as IScrollableListWindow;
         var_57.visible = false;
         var _loc2_:IWindow = var_57.findChildByTag("close");
         if(_loc2_ != null)
         {
      ...
      public function update() : void
      {
         ...
         if(_list != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_330.users.length)
            {
               _list.addListItem(createListItem(var_330.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_330.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = (var_330.windowManager as ICoreWindowManager).buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
