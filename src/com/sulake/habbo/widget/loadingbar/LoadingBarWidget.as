package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_369:Sprite = null;
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_369 = new Sprite();
            var_369.addChild(new Bitmap(_image));
            var_369.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_369.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_369);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1312 != "")
         {
            HabboWebTools.openWebPage(var_1312);
         }
      }
      ...
      override public function dispose() : void
      {
         if(var_369 != null)
         {
            var_369.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_369 = null;
         }
         if(_image != null)
         {
