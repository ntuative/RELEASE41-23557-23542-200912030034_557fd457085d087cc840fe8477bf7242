package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_478:int = 6;
      
      private static const const_336:int = 10;
      
      private static const const_1018:Number = 18;
      
      private static const const_1364:Number = 10;
      
      private static const const_1363:Number = 8;
       
      
      private var var_1154:Number;
      ...
      {
         _widget.onItemMouseOut(var_941,var_940,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_941,var_940,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1152 = param1.chatType;
         var_941 = param1.userId;
         var_760 = param1.userName;
         var_940 = param1.userCategory;
         _message = param1.text;
         var_1154 = param1.userX;
         var_192 = param1.userImage;
         var_942 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1152)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_98:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_242:
         ...
         if(var_192 != null)
         {
            ...
            _loc16_ = Math.max(_loc16_,var_192.height);
         }
         ...
         if(var_192 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               _loc28_.width = var_192.width;
               _loc28_.height = var_192.height;
               _loc28_.bitmap = new BitmapData(var_192.width,var_192.height,true,0);
               _loc28_.bitmap.copyPixels(var_192,var_192.rect,new Point(0,0));
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_381 = Math.max(0,(0 - _loc5_.height) / 2);
               _width += var_192.width;
            }
         }
         if(_loc18_ != null)
         {
            ...
            if(var_942 != 0)
            {
               _loc31_ = uint(var_942 >> 16 & 255);
               _loc32_ = uint(var_942 >> 8 & 255);
               _loc33_ = uint(var_942 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_336;
            }
            else
            {
               _loc19_.text = var_760 + ":";
               _loc19_.y += var_381;
               _loc19_.width = _loc19_.textWidth + const_336;
               _width += _loc19_.textWidth + const_336;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1152 == RoomWidgetChatUpdateEvent.const_242)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_760);
            }
            else if(var_1152 == RoomWidgetChatUpdateEvent.const_251)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_760);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_381;
            _loc20_.width = _loc20_.textWidth + const_478;
            _width += _loc20_.textWidth + const_478;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_336 + _loc20_.textWidth + const_478;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_941,var_940,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_941,var_940,_roomId,_roomCategory,param1);
      }
