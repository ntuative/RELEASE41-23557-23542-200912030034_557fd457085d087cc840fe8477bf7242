package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1097:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_162.state = RoomChatHistoryPulldown.const_184;
         ...
         var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_872,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - const_479,param3.y,const_479,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_301 ? Number(const_479) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_236 > 0 && param2)
         {
            if(var_1284)
            {
               if(Math.abs(param1 - var_236) <= const_785)
               {
                  return;
               }
               var_1284 = false;
            ...
            if(var_301)
            {
               ...
               _loc3_ = var_348 - _loc5_ / _loc4_;
               _loc3_ = Math.max(0,_loc3_);
               _loc3_ = Math.min(1,_loc3_);
               _loc6_ = param1 - var_236;
               _loc7_ = true;
               _loc8_ = true;
               if(var_50.scrollV < 1 - const_1097 / var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1508)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_301 && !var_1262)
         {
            ...
            var_162.state = RoomChatHistoryPulldown.const_323;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_162.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_184);
      }
