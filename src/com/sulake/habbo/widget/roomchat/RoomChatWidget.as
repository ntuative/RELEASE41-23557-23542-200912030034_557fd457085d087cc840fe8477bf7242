package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements ICoreUpdateReceiver
   {
      ...
      private static const const_762:int = 4000;
      
      private static const const_1069:int = 3;
      
      private static const const_90:int = 18;
      
      private static const const_1016:int = 25;
      
      private static const const_1067:int = 1;
      
      private static const const_272:int = 9;
      
      private static const const_484:int = 8;
      
      private static const const_342:int = 0;
      
      private static const const_485:int = (const_484 + const_342) * const_90 + const_90;
      ...
      private var var_338:IItemListWindow;
      ...
      private var var_2062:int = 150;
      
      private var var_480:Number = 1;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_227 = new Array();
         var_674 = new Point();
         var_159 = const_485 + const_272;
         super(param1,param2,param3);
         var_2063 = param5;
         var_43 = param1.createWindow("chat_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_34,new Rectangle(0,0,200,var_159 + RoomChatHistoryPulldown.const_70),null,0) as IWindowContainer;
         var_43.background = true;
         var_43.color = 33554431;
         var_43.tags.push("room_widget_chat");
         var_338 = param1.createWindow("chat_contentlist","",HabboWindowType.const_856,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(0,0,200,var_159),null,0) as IItemListWindow;
         var_43.addChild(var_338);
         var_141 = param1.createWindow("chat_active_content","",HabboWindowType.const_54,HabboWindowStyle.const_40,HabboWindowParam.const_68,new Rectangle(0,0,200,var_159),null,0) as IWindowContainer;
         var_338.addListItem(var_141);
         var_37 = new RoomChatHistoryViewer(this,param1,var_43,param2);
         var_2062 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_660,onChatMessage);
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_696,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_159 = const_485 + const_272;
         var_43.height = var_159 + var_37.pulldownBarHeight;
         var_338.width = 0 - 0;
         var_338.height = var_159;
         var_141.width = 0 - 0;
         if(historyViewerActive())
         {
            var_141.height = getTotalContentHeight() + const_272;
         }
         else
         {
            var_141.height = var_159;
         }
         var_338.scrollV = 1;
         if(!historyViewerActive())
         {
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_785)
         {
            resetArea();
            return;
         }
      ...
      private function processBuffer() : void
      {
         ...
         while(var_71.length > const_1067 || historyViewerActive() && false)
         {
         ...
         {
            activateItemFromBuffer();
            var_675 = getTimer() + const_762;
         }
         else
         {
            if(false && false)
            {
               var_562 = getItemSpacing(_itemList["-1"],var_71[0]);
            }
            else
            {
               var_562 = const_90;
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_674.x) * var_819;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_761;
         var _loc6_:Number = 0 + const_761 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1258 && !historyViewerActive())
         {
            resetArea();
            var_1258 = false;
         }
      ...
      {
         return "chat_" + var_2063.toString() + "_item_" + (var_2064++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_660,onChatMessage);
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_696,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_480);
            if(_loc2_ == -1)
            {
               param1.y = getAreaBottom() - (_loc3_ + 1) * const_90 - const_272;
            }
            else
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1016 * const_1069;
            if(_loc2_ + var_676 > var_562)
            {
               _loc2_ = var_562 - var_676;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1488 == 0)
            {
               var_1488 = param1.scale;
            }
            else
            {
               var_819 = param1.scale / var_1488;
            }
         }
         if(param1.positionDelta != null)
         {
            var_674.x += param1.positionDelta.x / var_819;
            var_674.y += param1.positionDelta.y / var_819;
         }
         if(param1.rect != null)
         {
            if(var_37 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_2062)
         {
            _loc2_ = _itemList.shift();
            _loc3_ = var_227.indexOf(_loc2_);
            if(_loc3_ > -1)
            {
               var_227.splice(_loc3_,1);
            }
            if(_loc2_.view != null)
            {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_480,1);
                  }
               }
               else
               {
               ...
               _loc1_.aboveLevels = var_480;
               if(_loc1_.aboveLevels > const_484 + const_342 + 2)
               {
                  _loc1_.aboveLevels = const_484 + const_342 + 2;
               }
               var_480 = 0;
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_159 = param1 - 0;
         var_43.height = var_159 + RoomChatHistoryPulldown.const_70;
         if(var_37 != null)
         {
            var_37.containerResized(var_43.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc6_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_312,param1,param2);
         messageListener.processWidgetMessage(_loc6_);
         var _loc7_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_579,param1,param3,param4);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_342 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1068)
               {
