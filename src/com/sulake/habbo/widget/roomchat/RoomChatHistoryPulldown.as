package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_742:int = 150;
      
      private static const const_743:int = 250;
      
      public static const const_70:int = 39;
       
      
      private var var_1395:BitmapData;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_1393:BitmapData;
      ...
      private var var_1394:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_43 = param3;
         var_1783 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1393 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1779 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1394 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1395 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1778 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1781 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_77 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_39,HabboWindowParam.const_68,new Rectangle(0,0,param3.width,param3.height - const_70),null,0,0) as IBitmapWrapperWindow;
         var_43.addChild(var_77);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_34,new Rectangle(0,0 - const_70,param3.width,const_70),null,0) as IWindowContainer;
         var_43.addChild(_window);
         var_104 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_447,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_70),null,0) as IRegionWindow;
         if(var_104 != null)
         {
            var_104.background = true;
            var_104.alphaTreshold = 0;
            var_104.addEventListener(WindowMouseEvent.const_53,onPulldownMouseDown);
            var_43.addChild(var_104);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_347:
               var_77.blend += param1 / const_743;
               _window.blend += param1 / const_743;
               if(false)
               {
                  state = const_323;
               }
               break;
            case const_747:
               var_77.blend = 0 - param1 / const_742;
               _window.blend = 0 - param1 / const_742;
               if(true)
               {
                  state = const_184;
               }
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_104.x = 0;
            var_104.y = 0 - const_70;
            var_104.width = 0 - var_1780;
         }
         if(var_77 != null)
         {
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1782 == _window.width)
         {
            return;
         }
         var_1782 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1783.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1393.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1393.clone(),_loc9_);
