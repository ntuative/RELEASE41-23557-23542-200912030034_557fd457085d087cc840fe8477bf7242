package com.sulake.habbo.widget.poll
{
   ...
   public class PollWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_116,showPollOffer);
         param1.addEventListener(RoomWidgetPollUpdateEvent.const_61,showPollError);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_116,showPollOffer);
         param1.removeEventListener(RoomWidgetPollUpdateEvent.const_61,showPollError);
      ...
      {
         var _loc2_:PollSession = var_252.getValue(param1) as PollSession;
         if(_loc2_)
         {
            _loc2_.showThanks();
            _loc2_.dispose();
      ...
      private function showPollContent(param1:Event) : void
      {
         ...
         {
            _loc3_ = _loc2_.id;
            _loc4_ = var_252.getValue(_loc3_) as PollSession;
            if(_loc4_)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_252)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_252.getWithIndex(0) as PollSession;
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
