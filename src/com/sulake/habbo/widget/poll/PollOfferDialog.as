package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_247:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_693:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1181:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  case "poll_offer_button_ok":
                     _state = const_1181;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_597,_id));
                     break;
                  case "poll_offer_button_cancel":
                     _state = const_693;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_454,_id));
