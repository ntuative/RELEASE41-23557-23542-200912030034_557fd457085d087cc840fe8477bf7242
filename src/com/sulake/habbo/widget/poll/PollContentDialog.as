package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_606[var_908] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_278)
         {
            ...
            var_278 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_278.center();
            var_278.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_908;
         if(var_908 < var_606.length)
         {
            _loc1_ = var_606[var_908] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_606.length);
                  _loc2_.text = _loc6_;
               }
