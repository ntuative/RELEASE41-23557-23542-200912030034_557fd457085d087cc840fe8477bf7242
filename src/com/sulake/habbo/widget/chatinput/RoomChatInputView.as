package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_478:int = 16;
      
      private static const const_1082:int = 20;
      
      private static const const_336:int = 10;
      
      private static const const_1081:int = 40;
      ...
      private var var_366:Number = 600;
      ...
      private var var_681:Timer;
      
      private var var_828:Timer;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1000 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_2093 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_2092 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_681 = new Timer(1000,1);
         var_681.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_828 = new Timer(5000,1);
         var_828.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_54,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_128,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_228,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_2094 = _loc2_.width + const_478 + _loc6_.width + const_1082;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1081,_loc8_.width) + const_478);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_1000 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_144 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_366);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_366);
         }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_484);
