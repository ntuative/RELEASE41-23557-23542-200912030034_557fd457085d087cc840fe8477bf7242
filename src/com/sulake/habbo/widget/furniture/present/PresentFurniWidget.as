package com.sulake.habbo.widget.furniture.present
{
   ...
   public class PresentFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_993:Number = 100;
       
      
      private var var_217:Boolean = false;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_58,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_73,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_460,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_360,onObjectUpdate);
         param1.addEventListener(RoomWidgetPresentDataUpdateEvent.const_430,onObjectUpdate);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_118,onRoomObjectRemoved);
         param1.addEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_58,onEcotronUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_58,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_73,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_460,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_369,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_360,onObjectUpdate);
         param1.removeEventListener(RoomWidgetPresentDataUpdateEvent.const_430,onObjectUpdate);
         param1.removeEventListener(RoomWidgetEcotronBoxDataUpdateEvent.const_58,onEcotronUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetPresentDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetPresentDataUpdateEvent.const_58:
               hideInterface();
               var_217 = false;
               ...
               showInterface();
               break;
            case RoomWidgetPresentDataUpdateEvent.const_369:
               if(!var_217)
               {
                  return;
               }
            ...
            case RoomWidgetPresentDataUpdateEvent.const_360:
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_430:
               if(!var_217)
               {
                  return;
               }
               ...
               break;
            case RoomWidgetPresentDataUpdateEvent.const_460:
               if(!var_217)
               {
                  return;
               }
      ...
      private function onEcotronUpdate(param1:RoomWidgetEcotronBoxDataUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetEcotronBoxDataUpdateEvent.const_58:
               hideInterface();
         }
      }
      ...
      {
         var _loc1_:* = null;
         if(var_217 || var_152 == -1 || !_controller)
         {
            return;
         }
         var_217 = true;
         ...
         {
            _loc1_ = new RoomWidgetPresentOpenMessage(RoomWidgetPresentOpenMessage.const_553,var_152);
      ...
      private function showInterface() : void
      {
         ...
         _window = windowManager.createWindow("presentcardui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_992,const_993,2,2),null,0) as IWindowContainer;
