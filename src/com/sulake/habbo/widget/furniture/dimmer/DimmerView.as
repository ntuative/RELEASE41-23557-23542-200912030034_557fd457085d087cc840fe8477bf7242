package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1045:XML;
      
      private var var_382:int;
      
      private var var_419:DimmerViewColorGrid;
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = var_234.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            var_234.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_992,const_993,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_419 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         ...
         var_234 = ITabContextWindow(_window.findChildByName("tab_context"));
         selectTab(_widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < var_234.numTabItems)
         {
            _loc6_ = var_234.getTabItemAt(_loc2_);
            _loc6_.setParamFlag(HabboWindowParam.const_34,true);
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_419 != null)
         {
            var_419.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = var_234.selector.getSelected();
         return var_234.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_876 = _loc2_.light;
         if(var_309 != null)
         {
            var_309.setValue(var_876);
         }
         var_382 = colors.indexOf(_loc2_.color);
         if(var_419 != null)
         {
            var_419.setSelectedColorIndex(var_382);
         }
