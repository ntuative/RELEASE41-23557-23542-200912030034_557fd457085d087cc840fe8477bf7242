package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_842:IWindow;
      
      private var var_844:IWindow;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(var_842 != null)
         {
            if(false)
            {
               _loc2_ = 0 / Number(var_179.duration);
               var_842.width = _loc2_ * var_366;
            }
            else
            {
               var_842.width = 0;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_844 = _window.findChildByName("effect_hilite");
            var_844.visible = false;
         }
         var_843 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_842 = _window.findChildByName("loader_bar");
         if(var_842 != null)
         {
            var_366 = var_842.width;
            var_166.start();
            onUpdate();
         }
         if(false)
         {
            setElementBitmap("effect_icon",var_179.icon);
         }
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_843 != null)
         {
            var_843.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_843.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
