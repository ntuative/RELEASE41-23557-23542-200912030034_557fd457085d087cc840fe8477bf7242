package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1553:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1549:String = "level";
      
      private var var_106:IItemListWindow;
      
      private const const_1548:String = "energy";
      
      private var var_1098:Map;
      
      private const const_1555:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1552:uint = 3355443;
      
      private var var_220:IBorderWindow;
      
      private const const_1550:int = 158;
      
      private const const_1554:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_247:PetCommandTool;
      
      private const const_1556:uint = 11184810;
      
      private const const_1551:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc3_:IWindow = var_220.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = var_220.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      private function updateStateElement(param1:String, param2:int, param3:int) : void
      {
         ...
         var _loc4_:IWindowContainer = var_106.getListItemByName("status_container") as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function set ageText(param1:int) : void
      {
         ...
         var _loc2_:ITextWindow = var_106.getListItemByName("age_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         if(var_247 == null)
         {
            var_247 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1098.getValue(var_692) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_247.showWindow(true);
            var_247.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function set image(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = var_106.getListItemByName("image_container") as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function set raceText(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = var_106.getListItemByName("race_text") as ITextWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1549,param1.level,param1.levelMax);
         updateStateElement(const_1551,param1.experience,param1.experienceMax);
         updateStateElement(const_1548,param1.energy,param1.energyMax);
         updateStateElement(const_1555,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_692 = param1.id;
         var_1098.remove(param1.id);
         var_1098.add(param1.id,param1);
         if(var_247 && var_247.isVisible() && param1.isOwnPet)
         {
            var_247.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      private function set petRespect(param1:int) : void
      {
         ...
         var _loc2_:IWindowContainer = var_106.getListItemByName("petrespect_container") as IWindowContainer;
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_247.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_388,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1550,const_1554,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1556);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1552);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1553);
         return _loc5_;
      }
