package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1558:int = 5;
      
      private const const_1559:int = 5;
      ...
      {
         var _loc2_:* = null;
         if(var_1113 != null && var_1113.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,var_117);
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_730 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_730 += param1.height + const_1559;
            return fit(param1);
         }
         param1.offset(_offsetX,var_730);
         _offsetX += param1.width + const_1558;
         return true;
      }
