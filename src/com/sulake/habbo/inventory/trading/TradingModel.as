package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_466:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_221:uint = 3;
      
      public static const const_171:uint = 1;
      
      public static const const_164:uint = 0;
      
      public static const const_1278:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_421 = false;
         var_585 = false;
         var_52.updateItemList(var_586);
         var_52.updateItemList(var_1047);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_52.alertPopup(TradingView.const_925);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_586)
            {
               var_421 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_585 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_52.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_586)
            {
               var_52.alertPopup(TradingView.const_927);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_421 + " OTHER: " + var_585);
         ...
         {
            case const_164:
               if(param1 == const_171 || param1 == const_195)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(var_208 == null || false)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_208.length)
         {
            _loc2_ = var_208.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         var_52.setMinimized(param1 != InventoryCategory.const_71);
      ...
      public function close() : void
      {
         if(var_565)
         {
            if(_state != const_164 && _state != const_195)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_164;
            var_28.toggleInventorySubPage(InventorySubCategory.const_970);
            var_565 = false;
         }
         var_52.setMinimized(false);
      }
