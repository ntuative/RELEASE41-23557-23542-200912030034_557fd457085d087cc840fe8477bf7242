package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_734:uint = 4284532064;
      
      private static const const_735:uint = 2577770;
      ...
      private var var_317:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_317 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_36.state)
                  {
                     case TradingModel.const_171:
                        if(var_36.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_914);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_153)
            {
               _loc6_ = "${poster_" + _loc4_.extras + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_778)
            {
            ...
            var_317.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_471);
            var_317.show();
         }
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_166)
            {
               var_166.removeEventListener(TimerEvent.TIMER,timerEventHandler);
               var_166.stop();
               var_166 = null;
            }
            if(var_317 != null)
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1359 == null)
         {
            var_1359 = createMinimizedWindow();
         }
         if(!var_1704)
         {
            return var_67;
      ...
      public function startConfirmCountdown() : void
      {
         if(var_166 == null)
         {
            var_166 = new Timer(1000,3);
            var_166.addEventListener(TimerEvent.TIMER,timerEventHandler);
         }
         var_166.reset();
         var_166.repeatCount = 3;
         var_166.start();
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_67)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_734) : uint(const_735);
            }
         ...
         if(var_67)
         {
            ...
            switch(var_36.state)
            {
               ...
               case TradingModel.const_221:
                  ...
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_466:
                  _loc1_.disable();
                  showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_195:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  showInfoMessage("${inventory.trading.info.confirm}");
                  break;
