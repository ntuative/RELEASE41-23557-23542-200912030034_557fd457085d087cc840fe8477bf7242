package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1565:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_59.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_59.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_435,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_59.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_94:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_435:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_59.getValue(InventoryCategory.const_510));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_59.getValue(InventoryCategory.const_71));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_987));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_59.getValue(InventoryCategory.const_159));
      }
      ...
      {
         var _loc2_:IInventoryModel = var_59.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1565);
         }
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_59.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         return AchievementsModel(var_59.getValue(InventoryCategory.const_315));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_786.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_786.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 0;
         while(_loc1_ < var_59.length)
         {
            _loc2_ = var_59.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_59.length)
         {
            _loc3_ = var_59.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_219:
      ...
      {
         return TradingModel(var_59.getValue(InventorySubCategory.const_219));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_521 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_786.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1435 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_59.getValue(InventoryCategory.const_263));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_435,roomSessionEventHandler);
         ...
         var_59.add(InventoryCategory.const_71,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_521);
         var_59.add(InventoryCategory.const_263,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_59.add(InventoryCategory.const_510,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_521);
         var_59.add(InventoryCategory.const_315,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_59.add(InventorySubCategory.const_219,_loc7_);
         var _loc8_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_59.add(InventorySubCategory.RECYCLER,_loc8_);
         ...
         var_59.add(InventoryCategory.const_159,_loc9_);
