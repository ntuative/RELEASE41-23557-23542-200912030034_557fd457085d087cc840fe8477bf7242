package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_284:PetsGridItem;
      ...
      private var var_477:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_477 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_529 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_529.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_284 != null)
         {
            var_284.setSelected(false);
         }
         var_284 = param1;
         if(var_284 != null)
         {
            var_284.setSelected(true);
         }
         ...
         if(param1.type == WindowEvent.const_55)
         {
            switch(param2.name)
            {
               case "tab_floor":
                  ...
                  break;
               case "tab_wall":
                  var_92.switchCategory(FurniModel.const_42);
            }
            selectPetsTab();
         }
      }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_284.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_529.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_477.removeGridItem(_loc2_.window);
         if(var_284 == _loc2_)
         {
            var_284 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_529.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_477.addGridItem(_loc2_.window);
            var_529.add(param1.id,_loc2_);
            if(var_284 == null)
            {
               selectFirst();
            }
