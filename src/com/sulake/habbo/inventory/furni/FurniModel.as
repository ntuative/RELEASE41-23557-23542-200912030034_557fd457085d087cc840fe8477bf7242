package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1025:int = 100;
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         _assets = param4;
         _roomEngine = param5;
         _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_202,onObjectPlaced);
         var_459 = new Timer(const_1025,1);
         var_459.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_219;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_386.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_386.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_584)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(_roomEngine != null)
            {
               if(false)
               {
                  _roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_202,onObjectPlaced);
               }
               _roomEngine = null;
            }
            _communication = null;
            ...
            if(var_459 != null)
            {
               var_459.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_459.stop();
               var_459 = null;
            }
            if(var_133 != null)
            {
               var_133.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_133.stop();
               var_133 = null;
            }
            if(var_640 != null)
      ...
      private function requestSelectedFurniToMover(param1:IItem) : void
      {
         ...
         if(param1.category == FurniCategory.const_153)
         {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_279)
         {
         ...
         else if(param3 == FurniCategory.const_286)
         {
         ...
         else if(param3 == FurniCategory.const_273)
         {
         ...
         if(var_640 == null)
         {
            var_640 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_640.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_219:
               ...
               break;
            case InventorySubCategory.const_970:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_133 = new Timer(param1,1);
            var_133.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_133.start();
         }
         else
         {
      ...
      {
         if(param1 == InventoryCategory.const_71 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_314:
                  _controller.toggleInventoryPage(InventoryCategory.const_159);
            }
         }
      }
      ...
      {
         if(var_778 && param1.type == RoomEngineObjectEvent.const_202)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_286 || _loc3_.category == FurniCategory.const_279 || _loc3_.category == FurniCategory.const_273)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_386.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_386 = new Map();
         var_386.add(const_41,new Array());
         var_386.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
