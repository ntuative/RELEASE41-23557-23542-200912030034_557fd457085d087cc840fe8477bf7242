package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1003:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         if(_loc7_ != null)
         {
            var_567 = BitmapData(_loc7_.content);
         }
         ...
         _thumbWidth = var_567.width;
         var_99 = var_567.height;
         var_1002 = param5;
         var_830 = param6;
         var_230 = Math.floor(var_1002 / _thumbWidth);
         var_32 = new BitmapData(var_1002,var_830);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_830)
         {
            _loc12_ = new BitmapData(var_32.width,var_830);
      ...
      {
         var _loc4_:* = null;
         var _loc3_:BitmapData = new BitmapData(var_567.width,var_567.height);
         if(param2)
         {
            _loc3_.copyPixels(_itemBgImageSelected,var_567.rect,new Point(0,0),null,null,false);
         }
         else
         {
            _loc3_.copyPixels(var_567,var_567.rect,new Point(0,0),null,null,false);
         }
         if(param1 != null)
         {
      ...
      private function getList() : Array
      {
         ...
         if(var_1003 != null)
         {
            _loc1_ = var_1003.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_485 = resolveRowCountFromList();
         if(var_485 == 0)
         {
            var_32 = new BitmapData(var_1002,var_830);
            return;
         }
         var_32 = new BitmapData(Math.max(var_230 * _thumbWidth,var_1002),Math.max(var_485 * var_99,var_830),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_485)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_230 && var_32.height < _loc3_.y * var_99)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_230 - 1),var_99);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_230 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_99),null,null,true);
         _loc4_ = new Rectangle(0,var_99,_thumbWidth * (var_230 - 1),0 - var_99);
