package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      private var var_42:IHabboCommunicationManager;
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         super();
         var_28 = param1;
         var_42 = var_28.communication;
         var_42.addHabboConnectionMessageEvent(new FurniListEvent(onFurniList));
         var_42.addHabboConnectionMessageEvent(new FurniListInsertEvent(onFurniListInsert));
         var_42.addHabboConnectionMessageEvent(new FurniListRemoveEvent(onFurniListRemove));
         var_42.addHabboConnectionMessageEvent(new FurniListUpdateEvent(onFurniListUpdate));
         var_42.addHabboConnectionMessageEvent(new PostItPlacedEvent(onPostItPlaced));
         var_42.addHabboConnectionMessageEvent(new AvatarEffectsMessageEvent(onAvatarEffects));
         var_42.addHabboConnectionMessageEvent(new AvatarEffectActivatedMessageEvent(onAvatarEffectActivated));
         var_42.addHabboConnectionMessageEvent(new AvatarEffectAddedMessageEvent(onAvatarEffectAdded));
         var_42.addHabboConnectionMessageEvent(new AvatarEffectExpiredMessageEvent(onAvatarEffectExpired));
         var_42.addHabboConnectionMessageEvent(new HabboActivityPointNotificationMessageEvent(onPixelBalance));
         var_42.addHabboConnectionMessageEvent(new CreditBalanceEvent(onCreditsBalance));
         var_42.addHabboConnectionMessageEvent(new ScrSendUserInfoEvent(onClubStatus));
         var_42.addHabboConnectionMessageEvent(new BadgesEvent(onBadges));
         var_42.addHabboConnectionMessageEvent(new HabboUserBadgesMessageEvent(onUserBadges));
         var_42.addHabboConnectionMessageEvent(new HabboAchievementNotificationMessageEvent(onAchievementReceived));
         var_42.addHabboConnectionMessageEvent(new AchievementsEvent(onAchievements));
         var_42.addHabboConnectionMessageEvent(new TradingAcceptEvent(onTradingAccepted,TradingAcceptParser));
         var_42.addHabboConnectionMessageEvent(new TradingConfirmationEvent(onTradingConfirmation,TradingConfirmationParser));
         var_42.addHabboConnectionMessageEvent(new TradingAlreadyOpenEvent(onTradingAlreadyOpen,TradingAlreadyOpenParser));
         var_42.addHabboConnectionMessageEvent(new TradingCloseEvent(onTradingClose,TradingCloseParser));
         var_42.addHabboConnectionMessageEvent(new TradingCompletedEvent(onTradingCompleted,TradingCompletedParser));
         var_42.addHabboConnectionMessageEvent(new TradingItemListEvent(onTradingItemList,TradingItemListParser));
         var_42.addHabboConnectionMessageEvent(new TradingNotOpenEvent(onTradingNotOpen,TradingNotOpenParser));
         var_42.addHabboConnectionMessageEvent(new TradingOpenEvent(onTradingOpen,TradingOpenParser));
         var_42.addHabboConnectionMessageEvent(new TradingOtherNotAllowedEvent(onTradingOtherNotAllowed,TradingOtherNotAllowedParser));
         var_42.addHabboConnectionMessageEvent(new TradingYouAreNotAllowedEvent(onTradingYouAreNotAllowed,TradingYouAreNotAllowedParser));
         var_42.addHabboConnectionMessageEvent(new OpenConnectionMessageEvent(onRoomClosed));
         var_42.addHabboConnectionMessageEvent(new CloseConnectionMessageEvent(onRoomClosed));
         var_42.addHabboConnectionMessageEvent(new FlatAccessDeniedMessageEvent(onRoomClosed));
         var_42.addHabboConnectionMessageEvent(new PetInventoryEvent(onPets));
         var_42.addHabboConnectionMessageEvent(new PetAddedToInventoryEvent(onPetAdded));
         var_42.addHabboConnectionMessageEvent(new PetRemovedFromInventoryEvent(onPetRemoved));
         var_42.addHabboConnectionMessageEvent(new PetInventoryUpdatedEvent(onPetInventoryUpdated));
      }
      ...
      public function onFurniListUpdate(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_71,false);
      }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_510);
         _loc2_.refreshViews();
         var_28.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_153)
            {
         ...
         _loc5_ = uint(_loc2_.method_3.length);
         _loc10_ = 0;
         while(_loc10_ < _loc5_)
         {
            _loc9_ = _loc2_.method_3[_loc10_] as ItemDataStructure;
            _loc7_ = _loc9_.itemTypeID;
            _loc8_ = String(_loc7_);
            if(!_loc9_.groupable)
            {
      ...
      private function getConnection() : IConnection
      {
         ...
         return var_42.getHabboMainConnection(null);
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_159);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_28.setInventoryCategoryInit(InventoryCategory.const_315);
      }
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         var_28.setInventoryCategoryInit(InventoryCategory.const_71);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_28.toggleInventorySubPage(InventorySubCategory.const_219);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_28.setInventoryCategoryInit(InventoryCategory.const_263);
      }
