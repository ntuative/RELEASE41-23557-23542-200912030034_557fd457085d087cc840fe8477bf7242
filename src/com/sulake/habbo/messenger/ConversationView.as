package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1039:int = 20;
      
      private static const const_752:int = 100;
       
      
      private var var_1961:IScrollbarWindow;
      
      private var var_126:HabboMessenger;
      
      private var var_1446:IContainerButtonWindow;
      
      private var var_466:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_126 = param1;
         var_1446 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1961 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_694 || param3.type == Message.const_639 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_466.messages.length - const_752);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_466.messages.length)
         {
            refreshEntry(true,_loc1_,var_466.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_466 == null || _loc1_.id != var_466.id)
         {
            var_466 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_752 + const_1039)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_126.send(new FollowFriendMessageComposer(var_466.id));
      }
      ...
      {
         if(param1 == Message.const_694)
         {
            return 4294967295;
         }
         if(param1 == Message.const_639)
         {
            return 4292801535;
         }
         if(param1 == Message.const_945)
         {
            return 4294927974;
         }
         if(param1 == Message.const_606)
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1038;
         param1.invalidate();
      }
   }
}
