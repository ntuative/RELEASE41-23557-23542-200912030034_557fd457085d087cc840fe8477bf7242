package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_1847:BitmapData = null;
      ...
      private var var_1846:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_370,0,0,_loc4_,var_1417,var_1846,var_1847));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_1845 = int(_config.getKey("interstitial.interval","30000"));
         var_1844 = int(_config.getKey("interstitial.show.time","5000"));
         var_1419 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1163 = _loc2_.imageUrl;
         var_1417 = _loc2_.clickUrl;
         if(var_1163 != "" && var_1417 != "")
         {
            _loc3_ = var_1163;
            ...
            _loc4_ = new URLRequest(var_1163);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1162 = _loc2_.imageUrl;
         var_1843 = _loc2_.clickUrl;
         var_637 = getTimer();
         if(var_1162 != "")
         {
            _loc3_ = var_1162;
            ...
            if(var_219 == null)
            {
               var_219 = new Timer(var_1844,1);
               var_219.addEventListener(TimerEvent.TIMER_COMPLETE,interstitialTimerComplete);
            }
            if(false)
            {
               var_219.reset();
            ...
            var_219.start();
            _loc4_ = new URLRequest(var_1162);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      {
         if(var_219 != null && true)
         {
            return;
         }
         if(isValidAdImage(param1))
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_449,0,0,param1.bitmapData,var_1843));
            var_637 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1847 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1419 > 0 && var_1418 >= var_1419)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_637;
         if(_loc1_ > var_1845)
         {
            ++var_1418;
      ...
      {
         var_619 = param2 as IHabboCommunicationManager;
         if(var_619 == null)
         {
            return;
         }
         _connection = var_619.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_368));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1846 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
