package com.sulake.habbo.moderation
{
   ...
   public class WindowTracker
   {
      ...
      public static const const_1221:int = 2;
      ...
      {
         var_1368 = new Dictionary();
         super();
      }
      
      private function getWindowsForType(param1:int) : Dictionary
      {
         var _loc2_:Dictionary = var_1368[param1];
         if(_loc2_ == null)
         {
            _loc2_ = new Dictionary();
            var_1368[param1] = _loc2_;
         }
         return _loc2_;
      }
