package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1426:IMessageComposer;
      ...
      private var var_1217:Dictionary;
      ...
      {
         var_794 = IWindowContainer(var_55.getXmlWindow("chatlog_roomheader"));
         var_795 = IWindowContainer(var_55.getXmlWindow("chatlog_chatline"));
         var_469 = new Timer(300,1);
         var_469.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_57 = IFrameWindow(var_55.getXmlWindow("chatlog_frame"));
         _list = IItemListWindow(var_57.findChildByName("chatline_list"));
         var_57.procedure = onWindow;
         var _loc1_:IWindow = var_57.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_55.connection.send(var_1426);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_794.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_57,var_55,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_43 || param2 != var_57)
         {
            return;
         }
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_795.clone());
         _loc4_.color = var_1217[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_57,var_55,_loc6_,param2.chatterId);
         }
