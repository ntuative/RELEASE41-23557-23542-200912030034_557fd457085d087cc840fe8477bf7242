package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1784.clone());
         ...
         new OpenRoomTool(var_57,var_55,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1784 = IWindowContainer(var_55.getXmlWindow("roomvisits_row"));
         ...
         var_57 = IFrameWindow(var_55.getXmlWindow("roomvisits_frame"));
      ...
      {
         return WindowTracker.const_1143;
      }
   }
}
