package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onUserinfoButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new UserInfoFrameCtrl(var_55,_userId),var_57,false,false,true);
      }
      ...
      private function onRoomToolButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new RoomToolCtrl(var_55,_roomId),var_57,false,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1220 ? 0 : 1,_roomId),var_55,WindowTracker.const_704,_roomId),var_57,false,false,true);
      }
      ...
      public function show() : void
      {
         if(var_57 == null)
         {
            var_57 = IFrameWindow(var_55.getXmlWindow("start_panel"));
            ...
            var_55.disableButton(var_55.initMsg.cfhPermission,var_57,"ticket_queue_but");
