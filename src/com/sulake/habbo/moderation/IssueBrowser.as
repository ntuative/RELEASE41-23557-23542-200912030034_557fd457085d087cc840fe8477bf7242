package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1498:IIssueBrowserView;
      
      private const const_1568:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1569:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1497:IIssueBrowserView;
      
      private const const_1574:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1570:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_234:ITabContextWindow;
      
      private var var_1499:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_345.view.width = var_234.container.width;
         var_345.view.height = var_234.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1570:
               if(var_1497 == null)
               {
                  var_1497 = new MyIssuesView(issueManager,this,var_234.container);
               }
               return var_1497;
            case const_1568:
               if(var_1498 == null)
               {
                  var_1498 = new OpenIssuesView(issueManager,this,var_234.container);
               }
               return var_1498;
            case const_1569:
               if(var_1499 == null)
               {
                  var_1499 = new PickedIssuesView(issueManager,this,var_234.container);
               }
               return var_1499;
            default:
               return null;
