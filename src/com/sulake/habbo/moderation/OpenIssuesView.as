package com.sulake.habbo.moderation
{
   ...
   public class OpenIssuesView implements IIssueBrowserView
   {
      ...
      private var var_1799:IssueListView;
      ...
      public function OpenIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         var_572 = param2;
         _window = var_572.createWindow("open_issues_xml") as IWindowContainer;
         param3.addChild(_window);
         var _loc4_:IItemListWindow = _window.findChildByName("issue_list") as IItemListWindow;
         var_1799 = new IssueListView(param1,param2,_loc4_,"open_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = _issueManager.getBundles(IssueManager.const_863);
         var_1799.update(_loc1_);
      }
   }
}
