package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_863:String = "issue_bundle_open";
      
      public static const const_516:String = "issue_bundle_my";
      
      public static const const_968:String = "issue_bundle_picked";
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_147 = new Map();
         var_850 = new Map();
         var_572 = new IssueBrowser(this,var_64.windowManager,var_64.assets);
         var_691 = [];
         var_849 = [];
         var_1017 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_1017.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in var_147)
         {
            ...
            {
               case const_863:
                  if(_loc4_.state == IssueMessageData.const_148)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_516:
                  if(_loc4_.state == IssueMessageData.const_417 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_691 = var_691.concat(_loc2_.getIssueIds());
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(var_850.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_850.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1260)
         {
            var_156.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_147)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  var_850.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_850.add(param1.issueId,_loc2_);
         ...
         if(var_691.indexOf(param1.issueId) != -1)
         {
            handleBundle(_loc3_.id);
         }
         if(param1.state == IssueMessageData.const_148)
         {
            _loc5_ = getBundles(const_516);
            _loc6_ = false;
            ...
            _loc8_ = var_849.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         var_1017.remove(param1);
         var_1017.add(param1,_loc3_);
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_417 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      {
         var _loc2_:* = var_1017.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function autoPick() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_148 && (_loc2_ == null || _loc3_.getPrioritySum() > _loc2_.getPrioritySum()))
            {
               _loc2_ = _loc3_;
            }
         }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_572 == null || !var_572.isOpen())
         {
            var_64.soundManager.playSound(HabboSoundTypesEnum.const_957);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_850.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_147.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_417 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
