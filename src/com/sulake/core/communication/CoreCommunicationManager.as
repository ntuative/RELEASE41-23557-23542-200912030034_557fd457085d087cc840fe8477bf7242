package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, ICoreUpdateReceiver
   {
      ...
      private var var_1758:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_442)
         {
            _loc10_;
            if(var_442[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
         ...
         var _loc5_:Array = var_622[_loc3_];
      ...
      {
         var _loc3_:Array = var_622[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
      ...
      {
         return var_442[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1127)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:Class = var_621[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_442)
         {
            _loc2_ = _loc5_;
            _loc5_;
      ...
      override public function dispose() : void
      {
         ...
         for each(_loc1_ in var_442)
         {
            _loc1_.dispose();
         }
         var_442 = null;
         var_621 = null;
         for each(_loc2_ in var_622)
         {
            while(true)
            {
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_940:
               _loc3_ = new SocketConnection(param1,this,var_1758);
               break;
            default:
               Logger.log("[CoreCommunicationManager] Unknown connectionType, can not create connection: " + param2);
         }
         var_442[param1] = _loc3_;
         return _loc3_;
      }
