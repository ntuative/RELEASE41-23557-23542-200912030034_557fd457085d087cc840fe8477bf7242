package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1345:uint = 1;
      
      protected static const const_1348:int = 5;
      
      protected static const const_996:uint = 7;
      ...
      protected var var_866:int;
      
      protected var var_2157:String = "";
      
      protected var var_349:int;
      
      protected var var_437:XML;
      
      protected var var_1299:Boolean = false;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_319 = this.getDefinition(_name) as Class;
         if(var_319 == null)
         {
         ...
         try
         {
            xmlClass = var_319.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
         ...
         var_437 = new XML(bytes.readUTFBytes(bytes.length));
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_415 == LibraryLoader.const_1344)
         {
            if(analyzeLibrary())
            {
               var_415 |= 0;
         ...
         if(var_415 == LibraryLoader.const_996)
         {
            var_1299 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_866 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_306,const_1348 - var_866);
