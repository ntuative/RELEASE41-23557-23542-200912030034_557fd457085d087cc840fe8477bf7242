package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_914:Array = new Array();
      ...
      public static const const_1220:String = "AssetLibraryUnloaded";
      
      public static const const_399:String = "AssetLibraryLoaded";
      
      public static const const_1120:String = "AssetLibraryLoadError";
       
      
      private var var_437:XML;
      
      private var var_376:Dictionary;
      ...
      private var var_612:Dictionary;
      
      private var _name:String;
      
      private var var_438:Boolean = true;
      
      private var var_319:Class;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_520;
         var_376 = new Dictionary(false);
         var_377 = new Dictionary(false);
         var_612 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_376)
         {
            _loc4_ = AssetTypeDeclaration(var_376[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_377)
         {
            _loc2_ = var_377[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_377[_loc1_];
         }
         for(_loc1_ in _loadedAssets)
         {
            delete _loadedAssets[_loc1_];
         }
         for(_loc1_ in var_612)
         {
            delete var_612[_loc1_];
         }
         if(var_1 != null)
         {
            var_1.dispose();
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_437 = _loc2_.manifest.copy();
         var_319 = _loc2_.resource;
         if(var_438)
         {
            AssetLibrary.fetchLibraryContents(this,var_437,var_319);
         }
         var_279 = true;
         dispatchEvent(new Event(AssetLibrary.const_399));
         if(var_438)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_377[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_890,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_876,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_883,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_845,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_377[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_376.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_376[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_914.splice(var_914.indexOf(this),1);
            --var_520;
            var_377 = null;
            var_612 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1120));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_376)
         {
            _loc3_ = AssetTypeDeclaration(var_376[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_612[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_868);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_437.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc6_ < _loc2_.length())
            {
               ...
               if(_loc3_.attribute("name") == param1)
               {
                  ...
                  _loc5_.setUnknownContent(var_319[param1]);
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_377[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_376[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
      ...
      {
         return var_319 != null ? false : false;
      }
   }
}
