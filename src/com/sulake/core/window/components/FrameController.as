package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1005:String = "_TITLE";
      
      private static const const_1032:String = "_CONTENT";
      
      private static const const_1031:String = "_HEADER";
      
      private static const const_1030:String = "_SCALER";
       
      
      private var _title:ITextWindow;
      
      private var var_74:IMargins;
      
      private var var_1299:Boolean = false;
      
      private var var_1185:IHeaderWindow;
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_74)
         {
            ...
            var_74 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_74;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_198);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_203);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_198,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_198,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1185 == null)
         {
            var_1185 = findChildByTag(const_1031) as IHeaderWindow;
            if(!var_1185)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1005) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1030) as IScalerWindow;
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_257,false);
         }
      ...
      {
         return content != null && var_1299 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_33 == null)
         {
            var_33 = findChildByTag(const_1032) as IWindowContainer;
            if(!var_33)
            {
