package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2220:Rectangle = new Rectangle();
       
      
      protected var var_206:Boolean;
      
      protected var var_74:TextMargins;
      
      protected var var_495:String = "none";
      
      protected var var_579:Number;
      
      protected var var_352:Number;
      
      protected var _field:TextField;
      
      protected var var_699:Boolean = false;
      ...
      {
         var_74 = new TextMargins(0,0,0,0,setTextMargins);
         var_206 = false;
         var_579 = 0;
         var_352 = 0;
         if(_field == null)
      ...
      private static function method_4(param1:TextController, param2:Boolean) : void
      {
         var _loc3_:TextFormat = param1.defaultTextFormat;
      ...
      {
         param1.var_74.dispose();
         param1.var_74 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      private static function method_9(param1:TextController, param2:int) : void
      {
      ...
      {
         return new Rectangle(var_579 * maxScrollH,var_352 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_699)
         {
            context.removeLocalizationListener(var_239,this);
         }
         if(var_74 != null)
         {
            var_74.dispose();
      ...
      {
         var_579 = param1;
         _field.scrollH = var_579 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_239 = param1;
         if(var_239.charAt(0) == "$" && var_239.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_239.slice(2,var_239.indexOf("}")),this);
            var_699 = true;
         }
         else if(_field != null)
         {
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_74.dispose();
            var_74 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_254,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1187,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_415,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_254,true));
         _loc1_.push(new PropertyStruct("always_show_selection",_field.alwaysShowSelection,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("border",_field.border,PropertyStruct.const_57,false));
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_415,true));
         _loc1_.push(new PropertyStruct("condense_white",_field.condenseWhite,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("embed_fonts",_field.embedFonts,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_254,true));
         _loc1_.push(new PropertyStruct("max_chars",_field.maxChars,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("mouse_wheel_enabled",_field.mouseWheelEnabled,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("multiline",_field.multiline,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_562,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_254,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_562,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_74.left,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_top",var_74.top,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_right",var_74.right,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_74.bottom,PropertyStruct.const_83,true));
         _loc1_.push(new PropertyStruct("auto_size",var_495,PropertyStruct.const_254,var_495 != TextFieldAutoSize.NONE));
         _loc1_.push(new PropertyStruct("bold",_field.defaultTextFormat.bold != false,PropertyStruct.const_57,_field.defaultTextFormat.bold != false));
         _loc1_.push(new PropertyStruct("italic",_field.defaultTextFormat.italic != false,PropertyStruct.const_57,_field.defaultTextFormat.italic != false));
         _loc1_.push(new PropertyStruct("underline",_field.defaultTextFormat.underline != false,PropertyStruct.const_57,_field.defaultTextFormat.underline != false));
         _loc1_.push(new PropertyStruct("kerning",_field.defaultTextFormat.kerning != false,PropertyStruct.const_57,_field.defaultTextFormat.kerning != false));
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_562,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_579 = var_579;
         _loc1_.var_352 = var_352;
         _loc1_.var_74 = var_74.clone(_loc1_.setTextMargins);
         _loc1_.var_495 = var_495;
         _loc1_.var_699 = var_699;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_495 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_495 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_495 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_495 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
