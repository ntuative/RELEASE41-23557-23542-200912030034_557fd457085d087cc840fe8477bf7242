package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_124 = context.create(name + "::submenu","",WindowType.const_355,var_87,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.const_99)
         {
            ...
            {
               if(param2.testStateFlag(WindowState.const_74))
               {
         ...
         else if(param1.type == WindowEvent.const_929)
         {
            if(param2 == var_124)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_437,var_87,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_301,var_87,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_423 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_423).setStateFlag(WindowState.const_48,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_499)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_422,getSubMenu(),subMenuEventProc);
                  var_499 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            var_423 = param1;
            closeMenuView();
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_284,this,null));
         }
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_499 = false;
            getTitleText().text = var_423 < var_422.length && var_423 > -1 ? "null" : caption;
         }
      }
   }
}
