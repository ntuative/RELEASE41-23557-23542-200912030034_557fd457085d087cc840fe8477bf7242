package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1096:String = "content";
      
      private static const const_1095:String = "selector";
       
      
      private var var_1048:Boolean = false;
      
      protected var var_873:ITabSelectorWindow;
      
      private var var_839:Boolean = false;
      
      protected var var_1518:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1518 == null)
         {
            var_1518 = findChildByTag(TabContextController.const_1096) as IWindowContainer;
         }
         return var_1518;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_873 == null)
         {
            var_873 = findChildByTag(TabContextController.const_1095) as ITabSelectorWindow;
            if(var_873 != null)
            {
               var_873.procedure = selectorEventProc;
            }
         }
         return var_873;
      }
      ...
      {
         return !!var_839 ? selector.iterator : null;
      }
