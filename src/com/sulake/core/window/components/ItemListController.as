package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_1290:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_73 = 0;
         param5 |= 0;
         _horizontal = param3 == WindowType.const_330;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         var _loc13_:Rectangle = new Rectangle(0,0,width,height);
         _container = _context.create("_CONTAINER","",WindowType.const_301,WindowStyle.const_234,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         _container.addEventListener(WindowEvent.const_43,containerEventHandler);
         _container.addEventListener(WindowEvent.const_451,containerEventHandler);
         _container.addEventListener(WindowEvent.const_294,containerEventHandler);
      ...
      {
         return new Rectangle(var_491 * maxScrollH,var_490 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_451,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_294,containerEventHandler);
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_491 = param1;
            _container.x = -var_491 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_697,PropertyStruct.const_57,var_697 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_492,PropertyStruct.const_57,var_492 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1034,PropertyStruct.const_57,var_1034 != false));
         return _loc1_;
      }
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               ...
               case "auto_arrange_items":
                  var_697 = _loc3_.value as Boolean;
                  break;
            }
            _loc4_++;
         }
      ...
      private function containerEventHandler(param1:Event) : void
      {
         switch(param1.type)
         {
            case WindowEvent.const_451:
               updateScrollAreaRegion();
               break;
            case WindowEvent.const_294:
               if(!var_1290)
               {
                  updateScrollAreaRegion();
               }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            if(_horizontal)
            {
               _container.setParamFlag(WindowParam.const_431,param1);
            }
            else
            {
