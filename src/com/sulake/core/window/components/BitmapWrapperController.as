package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               case "handle_bitmap_disposing":
                  var_417 = _loc3_.value as Boolean;
                  break;
               case "bitmap_asset_name":
                  var_1041 = _loc3_.value as String;
                  break;
            }
            _loc4_++;
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_417,PropertyStruct.const_57,var_417 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1041,PropertyStruct.const_254,var_1041 != null));
         return _loc1_;
      }
