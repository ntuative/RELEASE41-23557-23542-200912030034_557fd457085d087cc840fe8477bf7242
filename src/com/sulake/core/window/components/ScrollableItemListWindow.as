package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_331:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         if(_scrollBar.testStateFlag(WindowState.const_67))
         {
            hideScrollBar();
         }
      }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_331)
         {
            var_331 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_331)
            {
               var_331.addEventListener(WindowEvent.const_250,scrollBarEventProc);
               var_331.addEventListener(WindowEvent.const_208,scrollBarEventProc);
            }
         }
         return var_331;
      }
      ...
      override public function dispose() : void
      {
         if(var_331)
         {
            var_331.removeEventListener(WindowEvent.const_250,scrollBarEventProc);
            var_331.removeEventListener(WindowEvent.const_208,scrollBarEventProc);
            var_331 = null;
         }
         if(_cachedItemList)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_208)
         {
            hideScrollBar();
         }
      }
