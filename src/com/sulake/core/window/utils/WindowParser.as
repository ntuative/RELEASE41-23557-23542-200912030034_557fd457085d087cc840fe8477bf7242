package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1469:String = "_INCLUDE";
      
      public static const const_951:String = "_EXCLUDE";
      
      public static const const_1416:String = "_TEMP";
      
      private static const const_1059:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1060:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1042:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_871:Dictionary;
      
      protected var var_1302:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1301:Dictionary;
      
      protected var var_1043:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1043 = new Dictionary();
         var_1042 = new Dictionary();
         TypeCodeTable.fillTables(var_1043,var_1042);
         var_871 = new Dictionary();
         var_1301 = new Dictionary();
         ParamCodeTable.fillTables(var_871,var_1301);
         var_1302 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1060,"");
         return param1.replace(const_1059,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1043)
            {
               delete var_1043[_loc1_];
            }
            for(_loc1_ in var_1042)
            {
               delete var_1042[_loc1_];
            }
            for(_loc1_ in var_871)
            {
               delete var_871[_loc1_];
            }
            for(_loc1_ in var_1301)
            {
               delete var_1301[_loc1_];
            }
            var_1302.dispose();
            var_1302 = null;
            _context = null;
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_951) == -1)
                  {
