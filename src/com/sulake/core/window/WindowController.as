package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
      ...
      private var var_293:Rectangle;
      
      protected var var_578:Function;
      ...
      public function WindowController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_293 = new Rectangle();
         var_494 = 10;
         if(_loc13_ != null)
         {
            var_354 = new Rectangle(0,0,int(_loc13_.attribute("width")),int(_loc13_.attribute("height")));
            var_60 = var_354.clone();
            var_22 = var_354.clone();
         ...
         if(param8 != null)
         {
            ...
            if(var_30)
            {
               _context.invalidate(this,var_22,WindowRedrawFlag.const_72);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_120,WindowParam.const_138);
         var _loc2_:* = !testParamFlag(WindowParam.const_119,WindowParam.const_133);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            {
               ...
               if(_loc5_ == WindowParam.const_260)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_297)
               {
                  _loc3_.x += _loc4_;
               }
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_31 & 0);
               if(_loc5_ == WindowParam.const_223)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_307)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      {
         var_5 = param1;
         var_418 = !!var_5 ? uint(var_418 | _alphaColor) : uint(var_418 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_72);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_458)
         {
            return true;
         }
         _state = WindowState.const_458;
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_896,this,null);
         update(this,_loc1_);
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_1949 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_782:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_870:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1330:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1325:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_433:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_284:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_797:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_256:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_473:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_236:
               _loc2_ = "null";
         }
         if(_loc2_ == WindowEvent.const_155)
         {
      ...
      {
         var _loc3_:uint = var_87;
         var _loc4_:*;
         var_87 = !!param2 ? (_loc4_ = var_87 | param1, var_87 |= param1, uint(_loc4_)) : (_loc4_ = var_87 & ~param1, var_87 &= ~param1, uint(_loc4_));
         if(var_87 != _loc3_)
         {
      ...
      public function open() : Boolean
      {
         ...
         visible = true;
         _loc1_.type = WindowNotifyEvent.const_918;
         update(this,_loc1_);
         return true;
      }
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_782,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_870;
         update(this,_loc1_);
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_917;
         update(this,_loc1_);
         return true;
      }
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_833,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_983;
         update(this,_loc1_);
         return true;
      }
      ...
      {
         var_385 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         _context.invalidate(this,var_22,WindowRedrawFlag.const_903);
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_318,this,param1));
         return param1;
      }
      ...
      {
         return testLocalPointHitAgainstAlpha(param1,param2,var_494);
      }
      
      public function set color(param1:uint) : void
      {
         _alphaColor = param1 & 4278190080;
         var_418 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_72);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_539))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_886;
                  if(testParamFlag(WindowParam.const_303))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_188))
                        {
                  ...
                  if((var_31 & 0) > 0)
                  {
                     ...
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_259))
                        {
            ...
            switch(param2.type)
            {
               case WindowNotifyEvent.const_239:
                  ...
                  if(param1 == this)
                  {
                     ...
                     if(testParamFlag(WindowParam.const_157,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_167,WindowParam.const_133))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        _loc8_ = uint(var_31);
                        var_31 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_431))
                        {
                           var_23.width += 0 - 0;
                        }
                        ...
                        var_31 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_236,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_392:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_413);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_797,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_256,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_276:
                  if(param1 == this)
                  {
                     ...
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_204,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_367:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_955);
                  break;
               case WindowNotifyEvent.const_465:
                  _loc6_ = new Array();
                  ...
                  while(--_loc7_ > -1)
                  {
                     WindowController(_loc6_[_loc7_]).style = var_87;
                  }
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_72);
                  break;
               case WindowNotifyEvent.const_455:
                  if(!(var_31 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_413);
                     }
                  }
                  else if(var_31 & 0)
                  {
               ...
               case WindowNotifyEvent.const_204:
                  ...
                  break;
               case WindowNotifyEvent.const_473:
                  var_23.getRegionProperties(null,var_293);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_318:
      ...
      {
         return var_578 != null ? var_578 : (var_23 != null ? var_23.procedure : nullEventProc);
      }
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_851,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return testLocalPointHitAgainstAlpha(_loc3_,param2,var_494);
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_276;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_550,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_644;
         update(this,_loc1_);
         return true;
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_397)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_459)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_353)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_853,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_632,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_392,this,null));
            }
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_239,this,null));
            }
         }
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_367,this,null));
         }
      }
      ...
      public function lock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1299,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         setStateFlag(WindowState.const_60,true);
         _loc1_.type = WindowNotifyEvent.const_1133;
         update(this,_loc1_);
         return true;
      }
         ...
         if(var_307 && var_494 > 0)
         {
            if(!testParamFlag(WindowParam.const_32))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1444,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1444,param3,param1)) : false;
            }
         }
      ...
      public function setParamFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_31 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_455,this,null));
         }
      }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc9_:Boolean = getParamFlag(WindowParam.const_59);
         _loc1_ = 0;
         while(_loc1_ < _loc8_)
         {
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_293 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_409,this,var_23));
            }
            else
            {
               var_293.x = 0;
               ...
               var_293.width = 0;
               var_293.height = 0;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_822,this,_loc2_));
            }
         }
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_239,_type,var_87,var_31,_context,var_22,null,var_578,properties,var_580.concat(),_id) as WindowController;
         _loc2_.var_494 = var_494;
         _loc2_.var_307 = var_307;
         _loc2_.var_868 = var_868;
         _loc2_.var_293 = var_293.clone();
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1197,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_592;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_677;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      {
         var_494 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_891,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
