package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_687:ISkinContainer;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         var_531 = new Array();
         var_1410 = new Point();
         var_1409 = new Rectangle();
         var_286 = new Rectangle();
         var_287 = new Dictionary(true);
         var_687 = param1;
      ...
      {
         var _loc2_:WindowRendererItem = var_287[param1] as WindowRendererItem;
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            _loc1_ = var_531.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = getWindowRendererItem(_loc1_);
               var_286.x = _loc3_.dirty.x;
               var_286.y = _loc3_.dirty.y;
               var_286.width = _loc3_.dirty.width;
               var_286.height = _loc3_.dirty.height;
               renderWindowBranch(_loc1_,_loc3_,var_286);
            }
            _loc4_++;
         }
      }
      ...
      {
         param1.removeEventListener(WindowDisposeEvent.const_667,windowDisposedCallback);
         var _loc2_:WindowRendererItem = var_287[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete var_287[param1];
         }
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            _disposed = true;
            var_531 = null;
            for(_loc1_ in var_287)
            {
               delete var_287[_loc1_];
            }
            var_287 = null;
      ...
      private function renderWindowBranch(param1:WindowController, param2:WindowRendererItem, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param3,var_1410,var_1409))
            {
               if(param2.render(param1,var_1410,var_1409))
               {
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,_drawBufferAllocator,var_687);
            var_287[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_667,windowDisposedCallback);
         }
      }
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_72);
         }
      }
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            var_286.x = param2.x - param1.x;
            var_286.y = param2.y - param1.y;
            var_286.width = param2.width;
            var_286.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  var_286.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            getWindowRendererItem(param1).invalidate(param1,var_286,WindowRedrawFlag.const_247);
            if(var_531.indexOf(param1) == -1)
            {
               var_531.push(param1);
            }
         }
