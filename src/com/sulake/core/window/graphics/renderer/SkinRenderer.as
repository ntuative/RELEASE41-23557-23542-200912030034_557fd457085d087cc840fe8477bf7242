package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_302:Dictionary;
      
      protected var var_303:Dictionary;
      
      protected var var_412:Dictionary;
      
      public function SkinRenderer(param1:Array)
      {
         super();
         var_302 = new Dictionary();
      ...
      {
         var _loc3_:ISkinLayout = var_412[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_302[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_412)
         {
            ISkinLayout(var_412[_loc1_]).dispose();
            delete var_412[_loc1_];
         }
         var_412 = null;
         _layoutsByState = null;
         for(_loc1_ in var_302)
         {
            ISkinTemplate(var_302[_loc1_]).dispose();
            delete var_302[_loc1_];
         }
         var_302 = null;
         var_303 = null;
      }
