package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private var var_232:Boolean;
      
      private var var_100:BitmapData;
      
      private var var_865:Matrix;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_413:
            ...
            case WindowRedrawFlag.const_955:
               var_688 = var_687.getTheActualState(param1.type,param1.style,param1.state);
               if(var_688 != var_1014)
               {
                  var_232 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_903:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  var_232 = true;
                  _loc4_ = true;
      ...
      {
         return var_687.getTheActualState(param1.type,param1.style,param1.state) != var_1014;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_764) : uint(const_487);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_688) ? uint(const_765) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_765)
               {
                  ...
                  if(var_232)
                  {
                     ...
                     _loc6_.draw(param1,var_100,var_100.rect,var_688,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_100,var_865,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      {
         var _loc2_:ISkinRenderer = var_687.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_809)
            {
               _loc2_ = var_687.getSkinRendererByType(param1.type,WindowStyle.const_809);
            }
         }
         return _loc2_;
      }
